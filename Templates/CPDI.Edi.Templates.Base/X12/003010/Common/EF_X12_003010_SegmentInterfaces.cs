namespace EdiFabric.Templates.X12003010
{
    ...
    public interface I_E14
    {
        ...
        string MaximumUse_05 { get; set; }
        string LoopName_06 { get; set; }
        string LoopRepeatCount_07 { get; set; }
        string LoopLevelNumber_08 { get; set; }
        string NoteIdentificationNumber_09 { get; set; }
    }
    ...
    public interface I_G4
    {
        ...
        string EventDate_04 { get; set; }
        string EventTime_05 { get; set; }
    ...
    public interface I_GOV
    {
        ...
        string AssociationQualifierCode_01 { get; set; }
    ...
    public interface I_L8
    {
        ...
        string SpecialChargeCode_09 { get; set; }
    ...
    public interface I_LH3
    {
        ...
        string AdditionalHazardousInformation_02 { get; set; }
    }
    ...
    public interface I_NCD
    {
        ...
        string AssociationQualifierCode_05 { get; set; }
    ...
    public interface I_OTI
    {
        ...
        string GroupDate_06 { get; set; }
        string GroupTime_07 { get; set; }
    ...
    public interface I_R9
    {
        ...
        string TOFCIntermodalCodeQualifier_03 { get; set; }
        string StandardCarrierAlphaCode_04 { get; set; }
    }
    ...
    public interface I_SL1
    {
        ...
        string EffectiveDate_05 { get; set; }
    ...
    public interface I_V9
    {
        ...
        string EventDate_03 { get; set; }
        string EventTime_04 { get; set; }
