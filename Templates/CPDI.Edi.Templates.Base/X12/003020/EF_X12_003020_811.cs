namespace EdiFabric.Templates.X12003020
{
    ...
    public class Loop_HL_811
    {
        ...
        [DataMember]
        [Pos(3)]
        public virtual Loop_N1_811_2 N1Loop { get; set; }
        /// <summary>
    ...
    public class Loop_IT1_811
    {
        ...
        [DataMember]
        [Pos(11)]
        public virtual List<Loop_N1_811_3> N1Loop { get; set; }
    }
    ...
    public class TS811 : EdiMessage
    {
        ...
        [DataMember]
        [Pos(15)]
        public virtual List<Loop_N1_811_4> N1Loop2 { get; set; }
        /// <summary>
        /// Transaction Totals
        /// </summary>
        [DataMember]
