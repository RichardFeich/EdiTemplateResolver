namespace EdiFabric.Templates.X12003040
{
    ...
    /// <summary>
    /// Loop for Rail Shipment Information
    /// </summary>
    [Serializable()]
    [DataContract()]
    [Group(typeof(BNX))]
    public class Loop_BNX_426
    {
        ...
        [ListCount(500)]
        [Pos(4)]
        public virtual List<Loop_N7_426> N7Loop { get; set; }
        /// <summary>
        /// Waybill Reference
        /// </summary>
        [DataMember]
        ...
        [ListCount(10)]
        [Pos(10)]
        public virtual List<Loop_N1_426> N1Loop { get; set; }
        /// <summary>
        ...
        [ListCount(6)]
        [Pos(11)]
        public virtual List<Loop_S1_426> S1Loop { get; set; }
        /// <summary>
        ...
        [ListCount(12)]
        [Pos(13)]
        public virtual List<L7A> L7A { get; set; }
        /// <summary>
        /// Loop for Route Information
        /// </summary>
        [DataMember]
        [Required]
        [ListCount(13)]
        [Pos(14)]
        public virtual List<Loop_R2_426> R2Loop { get; set; }
        /// <summary>
        ...
        [ListCount(12)]
        [Pos(15)]
        public virtual List<RE> RE { get; set; }
        /// <summary>
        ...
        [ListCount(25)]
        [Pos(18)]
        public virtual List<Loop_LX_426> LXLoop { get; set; }
        /// <summary>
        ...
        [ListCount(64)]
        [Pos(19)]
        public virtual List<Loop_T1_426> T1Loop { get; set; }
        /// <summary>
        ...
        [ListCount(13)]
        [Pos(21)]
        public virtual List<L1A> L1A { get; set; }
        /// <summary>
        /// Customs Information
        /// </summary>
        [DataMember]
    ...
    public class Loop_L0_426
    {
        ...
        [DataMember]
        [Pos(4)]
        public virtual L7A L7A { get; set; }
    }
    ...
    public class Loop_LX_426
    {
        ...
        [ListCount(25)]
        [Pos(3)]
        public virtual List<Loop_L0_426> L0Loop { get; set; }
    }
    ...
    public class Loop_R2_426
    {
        ...
        [ListCount(4)]
        [Pos(2)]
        public virtual List<Loop_R2B_426> R2BLoop { get; set; }
    }
    ...
    public class Loop_R2B_426
    {
        ...
        [ListCount(5)]
        [Pos(3)]
        public virtual List<R2D> R2D { get; set; }
    }
    ...
    public class TS426 : EdiMessage
    {
        ...
        [DataMember]
        [Pos(9)]
        public virtual Loop_BNX_426 BNXLoop { get; set; }
        /// <summary>
