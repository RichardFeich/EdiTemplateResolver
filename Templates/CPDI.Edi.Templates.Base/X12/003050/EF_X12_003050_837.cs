namespace EdiFabric.Templates.X12003050
{
    ...
    public class Loop_CLM_837
    {
        ...
        [DataMember]
        [Pos(26)]
        public virtual Loop_LS_837 LSLoop { get; set; }
        /// <summary>
        /// Loop for Loop Header
        /// </summary>
        [DataMember]
        [Pos(27)]
        public virtual Loop_LS_837_2 LSLoop2 { get; set; }
        /// <summary>
    ...
    public class Loop_LS_837_2
    {
        ...
        [ListCount(10)]
        [Pos(2)]
        public virtual List<Loop_SBR_837_2> SBRLoop { get; set; }
        /// <summary>
        /// Loop Trailer
        /// </summary>
        [DataMember]
    ...
    public class Loop_LX_837
    {
        ...
        [ListCount(30)]
        [Pos(22)]
        public virtual List<REF> REF2 { get; set; }
        /// <summary>
        /// Monetary Amount
        /// </summary>
        [DataMember]
    ...
    /// <summary>
    /// Loop for Patient Information
    /// </summary>
    [Serializable()]
    [DataContract()]
    [Group(typeof(PAT))]
    public class Loop_PAT_837
    {
    ...
    public class Loop_SBR_837
    {
        ...
        [ListCount(99)]
        [Pos(4)]
        public virtual List<Loop_PAT_837> PATLoop { get; set; }
    }
    ...
    public class TS837 : EdiMessage
    {
        ...
        [Required]
        [Pos(5)]
        public virtual List<Loop_PRV_837> PRVLoop { get; set; }
        /// <summary>
