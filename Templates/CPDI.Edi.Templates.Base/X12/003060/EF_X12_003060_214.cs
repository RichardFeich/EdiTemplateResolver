namespace EdiFabric.Templates.X12003060
{
    ...
    public class Loop_LX_214
    {
        ...
        [ListCount(10)]
        [Pos(9)]
        public virtual List<Q6> Q6 { get; set; }
        /// <summary>
        /// Loop for Carton (Package) Detail
        /// </summary>
        [DataMember]
    ...
    public class Loop_LX_214_2
    {
        ...
        [DataMember]
        [Pos(9)]
        public virtual Loop_N1_214_2 N1Loop { get; set; }
    }
    ...
    public class Loop_REF_214
    {
        ...
        [ListCount(9999)]
        [Pos(7)]
        public virtual List<Loop_LX_214_2> LXLoop { get; set; }
    }
    ...
    public class TS214 : EdiMessage
    {
        ...
        /// <summary>
        /// Beginning Segment for Status, Discrepancy, and Appointment Schedule
        /// </summary>
        [DataMember]
        [Required]
        [Pos(2)]
        ...
        [ListCount(999999)]
        [Pos(10)]
        public virtual List<Loop_REF_214> REFLoop { get; set; }
        /// <summary>
