namespace EdiFabric.Templates.X12004000_Ace_Dev
{
    ...
    public class Loop_LX_199
    {
        ...
        [DataMember]
        [Pos(8)]
        public virtual List<Loop_NX1_199> NX1Loop { get; set; }
        /// <summary>
        /// Loop for Individual Identification
        /// </summary>
        [DataMember]
        [Pos(9)]
        public virtual List<Loop_IN1_199> IN1Loop { get; set; }
        /// <summary>
        /// Loop for Form Group
        /// </summary>
        [DataMember]
    ...
    public class TS199 : EdiMessage
    {
        ...
        [ListCount(5)]
        [Pos(3)]
        public virtual List<Loop_N1_199> N1Loop { get; set; }
        /// <summary>
        /// Loop for Assigned Number
        /// </summary>
        [DataMember]
        [Required]
        [Pos(4)]
        public virtual List<Loop_LX_199> LXLoop { get; set; }
        /// <summary>
