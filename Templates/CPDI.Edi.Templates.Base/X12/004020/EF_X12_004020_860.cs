namespace EdiFabric.Templates.X12004020
{
    ...
    public class Loop_AMT_860
    {
        ...
        [DataMember]
        [Pos(5)]
        public virtual List<Loop_FA1_860> FA1Loop { get; set; }
    }
    ...
    public class Loop_LDT_860_2
    {
        ...
        [DataMember]
        [Pos(5)]
        public virtual List<Loop_LM_860> LMLoop { get; set; }
    }
    ...
    public class Loop_LS_860
    {
        ...
        [DataMember]
        [Pos(2)]
        public virtual List<Loop_LDT_860_2> LDTLoop { get; set; }
        /// <summary>
        /// Loop Trailer
        /// </summary>
        [DataMember]
    ...
    public class Loop_N1_860_3
    {
        ...
        [DataMember]
        [Pos(19)]
        public virtual List<Loop_LDT_860_3> LDTLoop { get; set; }
    }
    ...
    public class Loop_POC_860
    {
        ...
        [ListCount(1000)]
        [Pos(10)]
        public virtual List<Loop_PID_860> PIDLoop { get; set; }
        /// <summary>
        /// Paperwork
        /// </summary>
        [DataMember]
        ...
        [ListCount(25)]
        [Pos(16)]
        public virtual List<Loop_SAC_860> SACLoop { get; set; }
        /// <summary>
        /// Conditions of Sale
        /// </summary>
        [DataMember]
        ...
        [DataMember]
        [Pos(37)]
        public virtual List<Loop_QTY_860> QTYLoop { get; set; }
        /// <summary>
        ...
        [ListCount(200)]
        [Pos(38)]
        public virtual List<Loop_SCH_860> SCHLoop { get; set; }
        /// <summary>
        /// Loop for Reference Identification
        /// </summary>
        [DataMember]
        [ListCount(1000)]
        [Pos(39)]
        public virtual List<Loop_N9_860> N9Loop { get; set; }
        /// <summary>
        /// Loop for Loop Header
        /// </summary>
        [DataMember]
        [Pos(40)]
        public virtual Loop_LS_860 LSLoop { get; set; }
        /// <summary>
        /// Loop for Name
        /// </summary>
        [DataMember]
        [ListCount(200)]
        [Pos(41)]
        public virtual List<Loop_N1_860_3> N1Loop { get; set; }
        /// <summary>
        ...
        [ListCount(1000)]
        [Pos(42)]
        public virtual List<Loop_SLN_860> SLNLoop { get; set; }
        /// <summary>
        /// Loop for Monetary Amount
        /// </summary>
        [DataMember]
        [Pos(43)]
        public virtual List<Loop_AMT_860_2> AMTLoop { get; set; }
        /// <summary>
        /// Loop for Code Source Information
        /// </summary>
        [DataMember]
    ...
    public class Loop_SLN_860
    {
        ...
        [DataMember]
        [Pos(15)]
        public virtual List<Loop_N9_860_2> N9Loop { get; set; }
        /// <summary>
        /// Loop for Name
        /// </summary>
        [DataMember]
        [ListCount(10)]
        [Pos(16)]
        public virtual List<Loop_N1_860_4> N1Loop { get; set; }
    }
    ...
    public class Loop_SPI_860
    {
        ...
        [ListCount(20)]
        [Pos(5)]
        public virtual List<Loop_N1_860_2> N1Loop { get; set; }
        /// <summary>
        /// Loop for Contract and Cost Accounting Standards Data
        /// </summary>
        [DataMember]
        [Pos(6)]
        public virtual List<Loop_CB1_860> CB1Loop { get; set; }
    }
    ...
    public class TS860 : EdiMessage
    {
        ...
        [Required]
        [Pos(2)]
        public virtual BCH BCH { get; set; }
        /// <summary>
        /// Currency
        /// </summary>
        [DataMember]
        ...
        [DataMember]
        [Pos(31)]
        public virtual List<Loop_LDT_860> LDTLoop { get; set; }
        /// <summary>
        /// Loop for Monetary Amount
        /// </summary>
        [DataMember]
        [Pos(32)]
        public virtual List<Loop_AMT_860> AMTLoop { get; set; }
        /// <summary>
        /// Loop for Reference Identification
        /// </summary>
        [DataMember]
        ...
        [ListCount(200)]
        [Pos(34)]
        public virtual List<Loop_N1_860> N1Loop { get; set; }
        /// <summary>
        /// Loop for Code Source Information
        /// </summary>
        [DataMember]
        ...
        [DataMember]
        [Pos(36)]
        public virtual List<Loop_SPI_860> SPILoop { get; set; }
        /// <summary>
        /// Loop for Advertising Demographic Information
        /// </summary>
        [DataMember]
        [Pos(37)]
        public virtual List<Loop_ADV_860> ADVLoop { get; set; }
        /// <summary>
        /// Loop for Line Item Change
        /// </summary>
        [DataMember]
        [Pos(38)]
        public virtual List<Loop_POC_860> POCLoop { get; set; }
        /// <summary>
        /// Loop for Transaction Totals
        /// </summary>
        [DataMember]
        [Pos(39)]
        public virtual Loop_CTT_860 CTTLoop { get; set; }
        /// <summary>
