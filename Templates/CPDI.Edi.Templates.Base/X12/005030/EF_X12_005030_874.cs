namespace EdiFabric.Templates.X12005030
{
    ...
    public class Loop_CS_874
    {
        ...
        [DataMember]
        [Pos(4)]
        public virtual List<Loop_SLN_874> SLNLoop { get; set; }
    }
    ...
    public class TS874 : EdiMessage
    {
        ...
        [Required]
        [Pos(5)]
        public virtual List<Loop_N1_874> N1Loop { get; set; }
        /// <summary>
        /// Loop for Extended Reference Information
        /// </summary>
        [DataMember]
        [Pos(6)]
        public virtual List<Loop_N9_874> N9Loop { get; set; }
        /// <summary>
        /// Loop for Contract Summary
        /// </summary>
        [DataMember]
        [Pos(7)]
        public virtual List<Loop_CS_874> CSLoop { get; set; }
        /// <summary>
