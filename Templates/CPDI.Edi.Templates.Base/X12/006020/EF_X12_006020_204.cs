namespace EdiFabric.Templates.X12006020
{
    ...
    /// <summary>
    /// Loop for Bill of Lading Handling Requirements
    /// </summary>
    [Serializable()]
    [DataContract()]
    [Group(typeof(AT5))]
    public class Loop_AT5_204
    {
    ...
    public class Loop_L5_204
    {
        ...
        [ListCount(99)]
        [Pos(3)]
        public virtual List<Loop_AT5_204> AT5Loop { get; set; }
        /// <summary>
        /// Business Instructions and Reference Number
        /// </summary>
        [DataMember]
    ...
    public class TS204 : EdiMessage
    {
        ...
        [DataMember]
        [Pos(16)]
        public virtual Loop_LX_204 LXLoop { get; set; }
        /// <summary>
