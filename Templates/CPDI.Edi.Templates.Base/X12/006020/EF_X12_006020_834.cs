namespace EdiFabric.Templates.X12006020
{
    ...
    /// <summary>
    /// Loop for Tax Advantage Account
    /// </summary>
    [Serializable()]
    [DataContract()]
    [Group(typeof(FSA))]
    ...
    public class Loop_INS_834
    {
        ...
        [DataMember]
        [Pos(10)]
        public virtual Loop_LS_834 LSLoop { get; set; }
    }
    ...
    public class Loop_LS_834
    {
        ...
        [DataMember]
        [Pos(2)]
        public virtual List<Loop_LX_834_2> LXLoop { get; set; }
        /// <summary>
        /// Loop Trailer
        /// </summary>
        [DataMember]
    ...
    public class Loop_LX_834_2
    {
        ...
        [Required]
        [Pos(2)]
        public virtual List<Loop_N1_834_2> N1Loop { get; set; }
    }
