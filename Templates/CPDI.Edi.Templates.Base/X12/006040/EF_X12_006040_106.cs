namespace EdiFabric.Templates.X12006040
{
    ...
    public class Loop_0400_106
    {
        ...
        [DataMember]
        [Pos(7)]
        public virtual Loop_MS2_106 LoopMS2 { get; set; }
        [DataMember]
        [Pos(8)]
        public virtual Loop_TF_106_2 LoopTF { get; set; }
        [DataMember]
        [Required]
        [ListCount(99999)]
        [Pos(9)]
        public virtual List<Loop_0430_106> Loop0430 { get; set; }
    }

    [Serializable()]
    [DataContract()]
    [Group(typeof(CA1))]
    public class Loop_0430_106
    {
        ...
        [ListCount(999)]
        [Pos(9)]
        public virtual List<Loop_0434_106> Loop0434 { get; set; }
        [DataMember]
        [Pos(10)]
        public virtual Loop_TF_106_2 LoopTF { get; set; }
    }
    ...
    public class TS106 : EdiMessage
    {
        ...
        [DataMember]
        [Pos(13)]
        public virtual Loop_TF_106 LoopTF { get; set; }
        [DataMember]
        [Required]
        [ListCount(10)]
        [Pos(14)]
        public virtual List<Loop_0200_106> Loop0200 { get; set; }
        [DataMember]
        [Required]
        [ListCount(99999)]
        [Pos(15)]
        public virtual List<Loop_0400_106> Loop0400 { get; set; }
        /// <summary>
