namespace EdiFabric.Templates.X12006040
{
    ...
    public class Loop_0200_211
    {
        ...
        [DataMember]
        [Pos(5)]
        public virtual Loop_AT2_211 LoopAT2 { get; set; }
        [DataMember]
        [ListCount(999999)]
        [Pos(6)]
        public virtual List<Loop_0220_211> Loop0220 { get; set; }
        [DataMember]
        [ListCount(2)]
        [Pos(7)]
        public virtual List<Loop_0230_211> Loop0230 { get; set; }
    }

    [Serializable()]
    [DataContract()]
    [Group(typeof(LX))]
    public class Loop_0220_211
    {
    ...
    public class Loop_0230_211
    {
        ...
        [ListCount(25)]
        [Pos(4)]
        public virtual List<Loop_0231_211> Loop0231 { get; set; }
    }

    [Serializable()]
    [DataContract()]
    [Group(typeof(LH1))]
    public class Loop_0231_211
    {
    ...
    public class TS211 : EdiMessage
    {
        ...
        [ListCount(10)]
        [Pos(10)]
        public virtual List<Loop_0100_211> Loop0100 { get; set; }
        [DataMember]
        [Required]
        [ListCount(9999)]
        [Pos(11)]
        public virtual List<Loop_0200_211> Loop0200 { get; set; }
        /// <summary>
