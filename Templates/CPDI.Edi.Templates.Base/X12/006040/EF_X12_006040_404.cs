namespace EdiFabric.Templates.X12006040
{
    ...
    public class Loop_L0_404
    {
        ...
        [ListCount(30)]
        [Pos(4)]
        public virtual List<Loop_PI_404> LoopPI { get; set; }
    }
    ...
    public class Loop_LH1_404
    {
        ...
        [ListCount(10)]
        [Pos(10)]
        public virtual List<Loop_N1_404_2> LoopN1 { get; set; }
    }
    ...
    public class Loop_LS_404
    {
        ...
        [ListCount(1000)]
        [Pos(2)]
        public virtual List<Loop_LH1_404> LoopLH1 { get; set; }
        /// <summary>
        // Loop Trailer
        /// </summary>
        [DataMember]
    ...
    public class Loop_LX_404
    {
        ...
        [ListCount(25)]
        [Pos(3)]
        public virtual List<Loop_L0_404> LoopL0 { get; set; }
        /// <summary>
        // Export License
        /// </summary>
        [DataMember]
    ...
    public class Loop_N7_404
    {
        ...
        [ListCount(36)]
        [Pos(3)]
        public virtual List<Loop_VC_404> LoopVC { get; set; }
        /// <summary>
        // Seal Numbers
        /// </summary>
        [DataMember]
        ...
        [ListCount(2)]
        [Pos(9)]
        public virtual List<Loop_E1_404> LoopE1 { get; set; }
        /// <summary>
        ...
        [ListCount(99)]
        [Pos(11)]
        public virtual List<Loop_REF_404> LoopREF { get; set; }
    }
    
    [Serializable()]
    [DataContract()]
    [Group(typeof(PI))]
    public class Loop_PI_404
    {
    ...
    public class Loop_REF_404
    {
        ...
        [ListCount(15)]
        [Pos(7)]
        public virtual List<Loop_N1_404_3> LoopN1 { get; set; }
    }
    ...
    public class Loop_VC_404
    {
        ...
        [ListCount(2)]
        [Pos(2)]
        public virtual List<Loop_N1_404_4> LoopN1 { get; set; }
    }
    ...
    public class TS404 : EdiMessage
    {
        ...
        [ListCount(500)]
        [Pos(10)]
        public virtual List<Loop_N7_404> LoopN7 { get; set; }
        /// <summary>
        ...
        [ListCount(15)]
        [Pos(14)]
        public virtual List<Loop_N1_404> LoopN1 { get; set; }
        [DataMember]
        [ListCount(12)]
        [Pos(15)]
        public virtual List<Loop_S1_404> LoopS1 { get; set; }
        /// <summary>
        // Route Information
        /// </summary>
        [DataMember]
        ...
        [ListCount(25)]
        [Pos(21)]
        public virtual List<Loop_LX_404> LoopLX { get; set; }
        [DataMember]
        [ListCount(64)]
        [Pos(22)]
        public virtual List<Loop_T1_404> LoopT1 { get; set; }
        /// <summary>
        ...
        [DataMember]
        [Pos(24)]
        public virtual Loop_LS_404 LoopLS { get; set; }
        /// <summary>
        // Administrative Communications Contact
        /// </summary>
        [DataMember]
