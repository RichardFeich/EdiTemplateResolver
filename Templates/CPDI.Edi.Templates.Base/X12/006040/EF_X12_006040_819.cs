namespace EdiFabric.Templates.X12006040
{
    ...
    public class Loop_JIL_819
    {
        ...
        [ListCount(1000)]
        [Pos(9)]
        public virtual List<Loop_JID_819> LoopJID { get; set; }
    }
    ...
    public class TS819 : EdiMessage
    {
        ...
        [ListCount(10)]
        [Pos(5)]
        public virtual List<Loop_N1_819> LoopN1 { get; set; }
        [DataMember]
        [Required]
        [ListCount(10000)]
        [Pos(6)]
        public virtual List<Loop_JIL_819> LoopJIL { get; set; }
        /// <summary>
        ...
        [ListCount(1000)]
        [Pos(10)]
        public virtual List<Loop_PSA_819> LoopPSA { get; set; }
        /// <summary>
        // Transaction Totals
        /// </summary>
        [DataMember]
