namespace EdiFabric.Templates.X12006040
{
    ...
    public class Loop_LDT_840_2
    {
        ...
        [DataMember]
        [Pos(4)]
        public virtual Loop_LM_840_3 LoopLM { get; set; }
    }
    ...
    public class Loop_N1_840_2
    {
        ...
        [ListCount(99999)]
        [Pos(20)]
        public virtual List<Loop_LDT_840_3> LoopLDT { get; set; }
    }
    ...
    public class Loop_PO1_840
    {
        ...
        [ListCount(1000)]
        [Pos(11)]
        public virtual List<Loop_PID_840> LoopPID { get; set; }
        /// <summary>
        // Paperwork
        /// </summary>
        [DataMember]
        ...
        [ListCount(99999)]
        [Pos(36)]
        public virtual List<Loop_LM_840> LoopLM { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(37)]
        public virtual List<Loop_QTY_840> LoopQTY { get; set; }
        [DataMember]
        [ListCount(104)]
        [Pos(38)]
        public virtual List<Loop_SCH_840> LoopSCH { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(39)]
        public virtual List<Loop_LDT_840_2> LoopLDT { get; set; }
        [DataMember]
        [ListCount(1000)]
        [Pos(40)]
        public virtual List<Loop_SLN_840> LoopSLN { get; set; }
        [DataMember]
        [ListCount(1000)]
        [Pos(41)]
        public virtual List<Loop_N9_840> LoopN9 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(42)]
        public virtual List<Loop_N1_840_2> LoopN1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(43)]
        public virtual List<Loop_PCT_840> LoopPCT { get; set; }
    }
    ...
    public class Loop_SPI_840
    {
        ...
        [ListCount(20)]
        [Pos(5)]
        public virtual List<Loop_N1_840_3> LoopN1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(6)]
        public virtual List<Loop_CB1_840> LoopCB1 { get; set; }
    }
    ...
    public class TS840 : EdiMessage
    {
        ...
        [ListCount(99999)]
        [Pos(28)]
        public virtual List<Loop_LDT_840> LoopLDT { get; set; }
        [DataMember]
        [ListCount(1000)]
        [Pos(29)]
        public virtual List<Loop_N9_840> LoopN9 { get; set; }
        ...
        [ListCount(10000)]
        [Pos(30)]
        public virtual List<Loop_N1_840> LoopN1 { get; set; }
        [DataMember]
        [Pos(31)]
        public virtual Loop_SPI_840 LoopSPI { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(32)]
        public virtual List<Loop_PCT_840> LoopPCT { get; set; }
        ...
        [ListCount(99999)]
        [Pos(33)]
        public virtual List<Loop_ADV_840> LoopADV { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(34)]
        public virtual List<Loop_LM_840> LoopLM { get; set; }
        ...
        [ListCount(100000)]
        [Pos(35)]
        public virtual List<Loop_PO1_840> LoopPO1 { get; set; }
        /// <summary>
        // Transaction Totals
        /// </summary>
        [DataMember]
