namespace EdiFabric.Templates.X12006040
{
    ...
    public class Loop_CON_845
    {
        ...
        [ListCount(99999)]
        [Pos(7)]
        public virtual List<Loop_N1_845_2> LoopN1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(8)]
        public virtual List<Loop_PAD_845> LoopPAD { get; set; }
    }
    ...
    public class Loop_CTP_845
    {
        ...
        [ListCount(10000)]
        [Pos(4)]
        public virtual List<Loop_N1_845_3> LoopN1 { get; set; }
    }
    ...
    public class Loop_PAD_845
    {
        ...
        [DataMember]
        [Pos(12)]
        public virtual Loop_LIN_845 LoopLIN { get; set; }
        [DataMember]
        [ListCount(10000)]
        [Pos(13)]
        public virtual List<Loop_N1_845_3> LoopN1 { get; set; }
        ...
        [ListCount(99999)]
        [Pos(14)]
        public virtual List<Loop_CTP_845> LoopCTP { get; set; }
    }
    ...
    public class TS845 : EdiMessage
    {
        ...
        [ListCount(10000)]
        [Pos(8)]
        public virtual List<Loop_N1_845> LoopN1 { get; set; }
        [DataMember]
        [Required]
        [ListCount(10000)]
        [Pos(9)]
        public virtual List<Loop_CON_845> LoopCON { get; set; }
        /// <summary>
        // Transaction Totals
        /// </summary>
        [DataMember]
