namespace EdiFabric.Templates.X12006040
{
    ...
    public class Loop_DTM_866
    {
        ...
        [ListCount(99999)]
        [Pos(5)]
        public virtual List<Loop_LIN_866> LoopLIN { get; set; }
    }
    ...
    public class Loop_LIN_866
    {
        ...
        [ListCount(100)]
        [Pos(6)]
        public virtual List<Loop_SLN_866> LoopSLN { get; set; }
    }
    ...
    public class Loop_SLN_866
    {
        ...
        [ListCount(99999)]
        [Pos(8)]
        public virtual List<Loop_PID_866> LoopPID { get; set; }
    }
    ...
    public class TS866 : EdiMessage
    {
        ...
        [ListCount(99999)]
        [Pos(4)]
        public virtual List<Loop_N1_866> LoopN1 { get; set; }
        [DataMember]
        [Required]
        [ListCount(100)]
        [Pos(5)]
        public virtual List<Loop_DTM_866> LoopDTM { get; set; }
        /// <summary>
        // Transaction Totals
        /// </summary>
        [DataMember]
