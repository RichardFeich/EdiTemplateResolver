namespace EdiFabric.Templates.X12006040
{
    ...
    public class Loop_0300_880
    {
        ...
        [ListCount(100)]
        [Pos(8)]
        public virtual List<Loop_0310_880> Loop0310 { get; set; }
    }

    [Serializable()]
    [DataContract()]
    [Group(typeof(G72))]
    public class Loop_0310_880
    {
    ...
    public class Loop_0400_880
    {
        ...
        [ListCount(99999)]
        [Pos(6)]
        public virtual List<Loop_0410_880> Loop0410 { get; set; }
    }

    [Serializable()]
    [DataContract()]
    [Group(typeof(REF))]
    public class Loop_0410_880
    {
        ...
        [ListCount(99999)]
        [Pos(5)]
        public virtual List<Loop_0411_880> Loop0411 { get; set; }
    }

    [Serializable()]
    [DataContract()]
    [Group(typeof(G17))]
    public class Loop_0411_880
    {
    ...
    public class TS880 : EdiMessage
    {
        ...
        [ListCount(10)]
        [Pos(11)]
        public virtual List<Loop_0100_880> Loop0100 { get; set; }
        [DataMember]
        [ListCount(100)]
        [Pos(12)]
        public virtual List<Loop_0200_880> Loop0200 { get; set; }
        [DataMember]
        [ListCount(9999)]
        [Pos(13)]
        public virtual List<Loop_0300_880> Loop0300 { get; set; }
        [DataMember]
        [ListCount(500)]
        [Pos(14)]
        public virtual List<Loop_0400_880> Loop0400 { get; set; }
        /// <summary>
