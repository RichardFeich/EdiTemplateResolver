namespace EdiFabric.Templates.X12006050
{
    ...
    public class Loop_HL_113
    {
        ...
        [ListCount(99999)]
        [Pos(2)]
        public virtual List<Loop_N9_113> LoopN9 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(3)]
        public virtual List<Loop_NM1_113_2> LoopNM1 { get; set; }
    }
    ...
    public class Loop_NM1_113_2
    {
        ...
        [ListCount(99999)]
        [Pos(15)]
        public virtual List<Loop_LQ_113> LoopLQ { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(16)]
        public virtual List<Loop_AWD_113_2> LoopAWD { get; set; }
    }
    ...
    public class TS113 : EdiMessage
    {
        ...
        [ListCount(99999)]
        [Pos(7)]
        public virtual List<Loop_NM1_113> LoopNM1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(8)]
        public virtual List<Loop_AWD_113> LoopAWD { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(9)]
        public virtual List<Loop_HL_113> LoopHL { get; set; }
        /// <summary>
