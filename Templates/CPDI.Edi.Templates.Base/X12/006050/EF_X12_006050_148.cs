namespace EdiFabric.Templates.X12006050
{
    ...
    public class Loop_CFI_148
    {
        ...
        [ListCount(999)]
        [Pos(9)]
        public virtual List<Loop_AD1_148> LoopAD1 { get; set; }
        [DataMember]
        [ListCount(999)]
        [Pos(10)]
        public virtual List<Loop_NM1_148_3> LoopNM1 { get; set; }
    }
    ...
    public class Loop_ESI_148
    {
        ...
        [ListCount(99)]
        [Pos(10)]
        public virtual List<Loop_LX_148_2> LoopLX { get; set; }
    }
    ...
    public class Loop_HL_148
    {
        ...
        [ListCount(999)]
        [Pos(13)]
        public virtual List<Loop_NM1_148> LoopNM1 { get; set; }
        [DataMember]
        [ListCount(99)]
        [Pos(14)]
        public virtual List<Loop_ESI_148> LoopESI { get; set; }
        [DataMember]
        [ListCount(999)]
        [Pos(15)]
        public virtual List<Loop_LN_148> LoopLN { get; set; }
        [DataMember]
        [Pos(16)]
        public virtual Loop_LS_148 LoopLS { get; set; }
        [DataMember]
        [ListCount(999)]
        [Pos(17)]
        public virtual List<Loop_CFI_148> LoopCFI { get; set; }
    }
    ...
    public class Loop_III_148
    {
        ...
        [ListCount(99999)]
        [Pos(7)]
        public virtual List<Loop_LM_148> LoopLM { get; set; }
    }
    ...
    public class Loop_LN_148
    {
        ...
        [ListCount(99999)]
        [Pos(3)]
        public virtual List<Loop_VEH_148> LoopVEH { get; set; }
        [DataMember]
        [ListCount(99)]
        [Pos(4)]
        public virtual List<Loop_AMT_148> LoopAMT { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(5)]
        public virtual List<Loop_NM1_148_5> LoopNM1 { get; set; }
    }
    ...
    public class Loop_LS_148
    {
        ...
        [ListCount(99999)]
        [Pos(2)]
        public virtual List<Loop_LX_148> LoopLX { get; set; }
        /// <summary>
        // Loop Trailer
        /// </summary>
        [DataMember]
    ...
    public class Loop_LX_148
    {
        ...
        [ListCount(99999)]
        [Pos(2)]
        public virtual List<Loop_III_148> LoopIII { get; set; }
        [DataMember]
        [ListCount(999)]
        [Pos(3)]
        public virtual List<Loop_NM1_148_4> LoopNM1 { get; set; }
    }
    ...
    public class TS148 : EdiMessage
    {
        ...
        [ListCount(999999)]
        [Pos(7)]
        public virtual List<Loop_HL_148> LoopHL { get; set; }
        /// <summary>
