namespace EdiFabric.Templates.X12006050
{
    ...
    public class Loop_HL_179
    {
        ...
        [ListCount(99999)]
        [Pos(8)]
        public virtual List<Loop_NM1_179_2> LoopNM1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(9)]
        public virtual List<Loop_LM_179> LoopLM { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(10)]
        public virtual List<Loop_N9_179> LoopN9 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(11)]
        public virtual List<Loop_OOI_179> LoopOOI { get; set; }
    }
    ...
    public class Loop_LQ_179_2
    {
        ...
        [ListCount(99999)]
        [Pos(7)]
        public virtual List<Loop_III_179> LoopIII { get; set; }
    }
    ...
    public class Loop_N9_179
    {
        ...
        [ListCount(99999)]
        [Pos(5)]
        public virtual List<Loop_QTY_179> LoopQTY { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(6)]
        public virtual List<Loop_LM_179> LoopLM { get; set; }
        ...
        [ListCount(99999)]
        [Pos(7)]
        public virtual List<Loop_NM1_179_3> LoopNM1 { get; set; }
    }
    ...
    public class Loop_NM1_179
    {
        ...
        [ListCount(99999)]
        [Pos(12)]
        public virtual List<Loop_QTY_179_3> LoopQTY { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(13)]
        public virtual List<Loop_OOI_179> LoopOOI { get; set; }
    ...
    public class Loop_NM1_179_3
    {
        ...
        [ListCount(99999)]
        [Pos(7)]
        public virtual List<Loop_QTY_179_2> LoopQTY { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(8)]
        public virtual List<Loop_LM_179> LoopLM { get; set; }
    ...
    public class TS179 : EdiMessage
    {
        ...
        [ListCount(99999)]
        [Pos(7)]
        public virtual List<Loop_NM1_179> LoopNM1 { get; set; }
        [DataMember]
        [Required]
        [ListCount(99999)]
        [Pos(8)]
        public virtual List<Loop_HL_179> LoopHL { get; set; }
        /// <summary>
