namespace EdiFabric.Templates.X12006050
{
    ...
    public class Loop_2000_186
    {
        ...
        [ListCount(99999)]
        [Pos(2)]
        public virtual List<Loop_2050_186> Loop2050 { get; set; }
    }

    [Serializable()]
    [DataContract()]
    [Group(typeof(LX))]
    public class Loop_2050_186
    {
        ...
        [ListCount(99999)]
        [Pos(2)]
        public virtual List<Loop_2075_186> Loop2075 { get; set; }
        [DataMember]
        [Required]
        [ListCount(99999)]
        [Pos(3)]
        public virtual List<Loop_2100_186> Loop2100 { get; set; }
    }

    [Serializable()]
    [DataContract()]
    [Group(typeof(NM1))]
    public class Loop_2075_186
    {
    ...
    public class Loop_2100_186
    {
        ...
        [ListCount(99999)]
        [Pos(4)]
        public virtual List<Loop_2150_186> Loop2150 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(5)]
        public virtual List<Loop_2200_186> Loop2200 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(6)]
        public virtual List<Loop_2300_186> Loop2300 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(7)]
        public virtual List<Loop_2350_186> Loop2350 { get; set; }
        [DataMember]
        [Pos(8)]
        public virtual Loop_LS_186 LoopLS { get; set; }
    }

    [Serializable()]
    [DataContract()]
    [Group(typeof(NM1))]
    public class Loop_2150_186
    {
    ...
    public class Loop_2200_186
    {
        ...
        [ListCount(99999)]
        [Pos(6)]
        public virtual List<Loop_2250_186> Loop2250 { get; set; }
    }

    [Serializable()]
    [DataContract()]
    [Group(typeof(NM1))]
    public class Loop_2250_186
    {
    ...
    public class Loop_2350_186
    {
        ...
        [ListCount(99999)]
        [Pos(2)]
        public virtual List<Loop_2400_186> Loop2400 { get; set; }
    }

    [Serializable()]
    [DataContract()]
    [Group(typeof(HL))]
    public class Loop_2400_186
    {
        ...
        [ListCount(99999)]
        [Pos(31)]
        public virtual List<Loop_2450_186> Loop2450 { get; set; }
    }

    [Serializable()]
    [DataContract()]
    [Group(typeof(EFI))]
    public class Loop_2450_186
    {
    ...
    public class Loop_2500_186
    {
        ...
        [ListCount(99999)]
        [Pos(6)]
        public virtual List<Loop_2550_186> Loop2550 { get; set; }
    }

    [Serializable()]
    [DataContract()]
    [Group(typeof(EFI))]
    public class Loop_2550_186
    {
    ...
    public class Loop_LS_186
    {
        ...
        [ListCount(99999)]
        [Pos(2)]
        public virtual List<Loop_2500_186> Loop2500 { get; set; }
        /// <summary>
        // Loop Trailer
        /// </summary>
        [DataMember]
    ...
    public class TS186 : EdiMessage
    {
        ...
        [ListCount(2)]
        [Pos(5)]
        public virtual List<Loop_1000_186> Loop1000 { get; set; }
        [DataMember]
        [Required]
        [ListCount(99999)]
        [Pos(6)]
        public virtual List<Loop_2000_186> Loop2000 { get; set; }
        /// <summary>
