namespace EdiFabric.Templates.X12006050
{
    ...
    public class TS190 : EdiMessage
    {
        ...
        [ListCount(99999)]
        [Pos(9)]
        public virtual List<Loop_AMT_190> LoopAMT { get; set; }
        [DataMember]
        [ListCount(2)]
        [Pos(10)]
        public virtual List<Loop_N1_190> LoopN1 { get; set; }
        [DataMember]
        [ListCount(5)]
        [Pos(11)]
        public virtual List<Loop_ENT_190> LoopENT { get; set; }
        [DataMember]
        [ListCount(100)]
        [Pos(12)]
        public virtual List<Loop_SES_190> LoopSES { get; set; }
        [DataMember]
        [ListCount(10)]
        [Pos(13)]
        public virtual List<Loop_DEG_190> LoopDEG { get; set; }
    }
}
