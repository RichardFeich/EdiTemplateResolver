namespace EdiFabric.Templates.X12006050
{
    ...
    public class Loop_BA1_601
    {
        ...
        [ListCount(10)]
        [Pos(9)]
        public virtual List<Loop_N1_601> LoopN1 { get; set; }
        [DataMember]
        [ListCount(999)]
        [Pos(10)]
        public virtual List<Loop_L13_601> LoopL13 { get; set; }
    }
    ...
    public class Loop_L13_601
    {
        ...
        [ListCount(10)]
        [Pos(5)]
        public virtual List<Loop_N1_601_2> LoopN1 { get; set; }
    }
    ...
    public class TS601 : EdiMessage
    {
        ...
        [ListCount(999)]
        [Pos(2)]
        public virtual List<Loop_BA1_601> LoopBA1 { get; set; }
        /// <summary>
