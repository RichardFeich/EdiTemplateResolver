namespace EdiFabric.Templates.X12006050
{
    ...
    public class Loop_PO1_836
    {
        ...
        [ListCount(99999)]
        [Pos(14)]
        public virtual List<Loop_REF_836> LoopREF { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(15)]
        public virtual List<Loop_SLN_836> LoopSLN { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(16)]
        public virtual List<Loop_N1_836_2> LoopN1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(17)]
        public virtual List<Loop_LM_836> LoopLM { get; set; }
    }
    ...
    public class TS836 : EdiMessage
    {
        ...
        [ListCount(99999)]
        [Pos(13)]
        public virtual List<Loop_N1_836> LoopN1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(14)]
        public virtual List<Loop_LM_836> LoopLM { get; set; }
        ...
        [ListCount(99999)]
        [Pos(15)]
        public virtual List<Loop_PO1_836> LoopPO1 { get; set; }
        /// <summary>
