namespace EdiFabric.Templates.X12006050
{
    ...
    public class Loop_CON_844
    {
        ...
        [ListCount(99999)]
        [Pos(5)]
        public virtual List<Loop_N1_844_2> LoopN1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(6)]
        public virtual List<Loop_PAD_844> LoopPAD { get; set; }
    }
    ...
    public class Loop_N1_844_2
    {
        ...
        [ListCount(99999)]
        [Pos(7)]
        public virtual List<Loop_SII_844> LoopSII { get; set; }
    }
    ...
    public class TS844 : EdiMessage
    {
        ...
        [ListCount(50)]
        [Pos(8)]
        public virtual List<Loop_N1_844> LoopN1 { get; set; }
        [DataMember]
        [Required]
        [ListCount(10000)]
        [Pos(9)]
        public virtual List<Loop_CON_844> LoopCON { get; set; }
        /// <summary>
        // Transaction Totals
        /// </summary>
        [DataMember]
