namespace EdiFabric.Templates.X12006050
{
    ...
    public class Loop_CDI_872
    {
        ...
        [ListCount(99999)]
        [Pos(2)]
        public virtual List<Loop_LX_872> LoopLX { get; set; }
    }
    ...
    public class Loop_IN1_872
    {
        ...
        [ListCount(10)]
        [Pos(8)]
        public virtual List<Loop_SCM_872> LoopSCM { get; set; }
        [DataMember]
        [ListCount(10)]
        [Pos(9)]
        public virtual List<Loop_NX1_872_2> LoopNX1 { get; set; }
    }
    ...
    public class Loop_LRQ_872
    {
        ...
        [ListCount(99999)]
        [Pos(9)]
        public virtual List<Loop_CDI_872> LoopCDI { get; set; }
        [DataMember]
        [ListCount(10)]
        [Pos(10)]
        public virtual List<Loop_SCM_872> LoopSCM { get; set; }
        ...
        [ListCount(5)]
        [Pos(11)]
        public virtual List<Loop_NX1_872> LoopNX1 { get; set; }
        [DataMember]
        [ListCount(12)]
        [Pos(12)]
        public virtual List<Loop_IN1_872> LoopIN1 { get; set; }
        [DataMember]
        [Pos(13)]
        public virtual Loop_REA_872 LoopREA { get; set; }
        [DataMember]
        [Pos(14)]
        public virtual Loop_MCD_872 LoopMCD { get; set; }
        [DataMember]
        [Pos(15)]
        public virtual Loop_PRJ_872 LoopPRJ { get; set; }
    }
    ...
    public class Loop_NM1_872
    {
        ...
        [ListCount(99999)]
        [Pos(3)]
        public virtual List<Loop_LRQ_872> LoopLRQ { get; set; }
    }
    ...
    public class Loop_NX1_872
    {
        ...
        [ListCount(5)]
        [Pos(3)]
        public virtual List<Loop_PAS_872> LoopPAS { get; set; }
    }
    ...
    public class Loop_PAS_872
    {
        ...
        [ListCount(99999)]
        [Pos(4)]
        public virtual List<Loop_REF_872> LoopREF { get; set; }
    }
    ...
    public class TS872 : EdiMessage
    {
        ...
        [ListCount(99999)]
        [Pos(4)]
        public virtual List<Loop_NM1_872> LoopNM1 { get; set; }
        /// <summary>
