namespace EdiFabric.Templates.X12006050
{
    ...
    public class Loop_0300_888
    {
        ...
        [ListCount(99999)]
        [Pos(4)]
        public virtual List<Loop_0310_888> Loop0310 { get; set; }
    }

    [Serializable()]
    [DataContract()]
    [Group(typeof(LX))]
    public class Loop_0310_888
    {
        ...
        [ListCount(99999)]
        [Pos(27)]
        public virtual List<Loop_0311_888> Loop0311 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(28)]
        public virtual List<Loop_0312_888> Loop0312 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(29)]
        public virtual List<Loop_0313_888> Loop0313 { get; set; }
    }

    [Serializable()]
    [DataContract()]
    [Group(typeof(N1))]
    public class Loop_0311_888
    {
    ...
    public class TS888 : EdiMessage
    {
        ...
        [ListCount(99999)]
        [Pos(3)]
        public virtual List<Loop_0100_888> Loop0100 { get; set; }
        /// <summary>
        // Extended Reference Information
        /// </summary>
        [DataMember]
        ...
        [ListCount(99999)]
        [Pos(10)]
        public virtual List<Loop_0200_888> Loop0200 { get; set; }
        [DataMember]
        [Required]
        [ListCount(99999)]
        [Pos(11)]
        public virtual List<Loop_0300_888> Loop0300 { get; set; }
        /// <summary>
