namespace EdiFabric.Templates.X12007010
{
    ...
    public class Loop_LS_200
    {
        ...
        [ListCount(20)]
        [Pos(2)]
        public virtual List<Loop_NTE_200> LoopNTE { get; set; }
        /// <summary>
        // Loop Trailer
        /// </summary>
        [DataMember]
    ...
    public class Loop_LS_200_2
    {
        ...
        [ListCount(99999)]
        [Pos(2)]
        public virtual List<Loop_REF_200> LoopREF { get; set; }
        /// <summary>
        // Loop Trailer
        /// </summary>
        [DataMember]
    ...
    public class Loop_LX_200
    {
        ...
        [ListCount(15)]
        [Pos(3)]
        public virtual List<Loop_IN1_200> LoopIN1 { get; set; }
        [DataMember]
        [Required]
        [ListCount(10)]
        [Pos(4)]
        public virtual List<Loop_NX1_200_2> LoopNX1 { get; set; }
        [DataMember]
        [ListCount(20)]
        [Pos(5)]
        public virtual List<Loop_N1_200_4> LoopN1 { get; set; }
    }
    ...
    public class Loop_N1_200_4
    {
        ...
        [ListCount(5)]
        [Pos(10)]
        public virtual List<Loop_SOI_200> LoopSOI { get; set; }
    }
    ...
    public class Loop_RO_200
    {
        ...
        [ListCount(6)]
        [Pos(7)]
        public virtual List<Loop_AMT_200> LoopAMT { get; set; }
        [DataMember]
        [Required]
        [ListCount(5)]
        [Pos(8)]
        public virtual List<Loop_N1_200_3> LoopN1 { get; set; }
    }
    ...
    public class Loop_SOI_200
    {
        ...
        [ListCount(7)]
        [Pos(6)]
        public virtual List<Loop_AIN_200> LoopAIN { get; set; }
    }
    ...
    public class Loop_VAR_200
    {
        ...
        [ListCount(10)]
        [Pos(7)]
        public virtual List<Loop_NX1_200> LoopNX1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(8)]
        public virtual List<Loop_N1_200_2> LoopN1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(9)]
        public virtual List<Loop_SCM_200> LoopSCM { get; set; }
    }
    ...
    public class TS200 : EdiMessage
    {
        ...
        [ListCount(20)]
        [Pos(10)]
        public virtual List<Loop_N1_200> LoopN1 { get; set; }
        [DataMember]
        [Required]
        [ListCount(2)]
        [Pos(11)]
        public virtual List<Loop_LX_200> LoopLX { get; set; }
        [DataMember]
        [ListCount(1000)]
        [Pos(12)]
        public virtual List<Loop_TLN_200> LoopTLN { get; set; }
        [DataMember]
        [ListCount(500)]
        [Pos(13)]
        public virtual List<Loop_RO_200> LoopRO { get; set; }
        [DataMember]
        [ListCount(5)]
        [Pos(14)]
        public virtual List<Loop_CCI_200> LoopCCI { get; set; }
        [DataMember]
        [ListCount(100)]
        [Pos(15)]
        public virtual List<Loop_INQ_200> LoopINQ { get; set; }
        [DataMember]
        [ListCount(25)]
        [Pos(16)]
        public virtual List<Loop_VAR_200> LoopVAR { get; set; }
        [DataMember]
        [Pos(17)]
        public virtual Loop_LS_200 LoopLS { get; set; }
        [DataMember]
        [Pos(18)]
        public virtual Loop_LS_200_2 LoopLS2 { get; set; }
        /// <summary>
