namespace EdiFabric.Templates.X12007010
{
    ...
    public class Loop_IN1_201
    {
        ...
        [ListCount(99999)]
        [Pos(14)]
        public virtual List<Loop_AIN_201> LoopAIN { get; set; }
        [DataMember]
        [ListCount(20)]
        [Pos(15)]
        public virtual List<Loop_PEX_201> LoopPEX { get; set; }
        [DataMember]
        [ListCount(10)]
        [Pos(16)]
        public virtual List<Loop_NX1_201_2> LoopNX1 { get; set; }
        [DataMember]
        [ListCount(20)]
        [Pos(17)]
        public virtual List<Loop_N1_201_2> LoopN1 { get; set; }
        [DataMember]
        [ListCount(20)]
        [Pos(18)]
        public virtual List<Loop_REA_201> LoopREA { get; set; }
        [DataMember]
        [ListCount(20)]
        [Pos(19)]
        public virtual List<Loop_NM1_201> LoopNM1 { get; set; }
        [DataMember]
        [ListCount(100)]
        [Pos(20)]
        public virtual List<Loop_CDA_201> LoopCDA { get; set; }
        [DataMember]
        [ListCount(100)]
        [Pos(21)]
        public virtual List<Loop_FAA_201> LoopFAA { get; set; }
        [DataMember]
        [Pos(22)]
        public virtual Loop_LS_201 LoopLS { get; set; }
    }
    ...
    public class Loop_LRQ_201
    {
        ...
        [ListCount(10)]
        [Pos(14)]
        public virtual List<Loop_NX1_201> LoopNX1 { get; set; }
        [DataMember]
        [Required]
        [ListCount(20)]
        [Pos(15)]
        ...
        [ListCount(99999)]
        [Pos(16)]
        public virtual List<Loop_AMT_201> LoopAMT { get; set; }
        [DataMember]
        [Required]
        [ListCount(15)]
        [Pos(17)]
        public virtual List<Loop_IN1_201> LoopIN1 { get; set; }
        [DataMember]
        [Required]
        [ListCount(99999)]
        [Pos(18)]
        public virtual List<Loop_LX_201> LoopLX { get; set; }
    }
    ...
    public class Loop_LS_201
    {
        ...
        [ListCount(10)]
        [Pos(2)]
        public virtual List<Loop_AMT_201_2> LoopAMT { get; set; }
        /// <summary>
        // Loop Trailer
        /// </summary>
        [DataMember]
    ...
    public class TS201 : EdiMessage
    {
        ...
        [ListCount(5)]
        [Pos(3)]
        public virtual List<Loop_N1_201> LoopN1 { get; set; }
        [DataMember]
        [Required]
        [ListCount(99999)]
        [Pos(4)]
        public virtual List<Loop_LRQ_201> LoopLRQ { get; set; }
        /// <summary>
