namespace EdiFabric.Templates.X12007010
{
    ...
    public class Loop_1000_214
    {
        ...
        [ListCount(10)]
        [Pos(8)]
        public virtual List<Loop_1100_214> Loop1100 { get; set; }
        [DataMember]
        [ListCount(5)]
        [Pos(9)]
        public virtual List<Loop_1200_214> Loop1200 { get; set; }
        [DataMember]
        [ListCount(999999)]
        [Pos(10)]
        public virtual List<Loop_1300_214> Loop1300 { get; set; }
    }

    [Serializable()]
    [DataContract()]
    [Group(typeof(AT7))]
    public class Loop_1100_214
    {
    ...
    public class TS214 : EdiMessage
    {
        ...
        [ListCount(999999)]
        [Pos(4)]
        public virtual List<Loop_1000_214> Loop1000 { get; set; }
        /// <summary>
