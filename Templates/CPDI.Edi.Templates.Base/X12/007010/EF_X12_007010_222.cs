namespace EdiFabric.Templates.X12007010
{
    ...
    public class Loop_2000_222
    {
        ...
        [ListCount(25)]
        [Pos(6)]
        public virtual List<Loop_2100_222> Loop2100 { get; set; }
        [DataMember]
        [Required]
        [ListCount(99)]
        [Pos(7)]
        public virtual List<Loop_2200_222> Loop2200 { get; set; }
    }
    
    [Serializable()]
    [DataContract()]
    [Group(typeof(LX))]
    public class Loop_2100_222
    {
    ...
    public class Loop_2200_222
    {
        ...
        [Required]
        [Pos(7)]
        public virtual Loop_N1_222 LoopN1 { get; set; }
        [DataMember]
        [ListCount(99)]
        [Pos(8)]
        public virtual List<Loop_2400_222> Loop2400 { get; set; }
        [DataMember]
        [ListCount(25)]
        [Pos(9)]
        public virtual List<Loop_2600_222> Loop2600 { get; set; }
    }
    
    [Serializable()]
    [DataContract()]
    [Group(typeof(LAD))]
    public class Loop_2400_222
    {
        ...
        [DataMember]
        [Pos(2)]
        public virtual Loop_G61_222 LoopG61 { get; set; }
    }
    
    [Serializable()]
    [DataContract()]
    [Group(typeof(LH1))]
    public class Loop_2415_222
    {
    ...
    public class Loop_G61_222
    {
        ...
        [ListCount(25)]
        [Pos(4)]
        public virtual List<Loop_2415_222> Loop2415 { get; set; }
    }
    ...
    public class TS222 : EdiMessage
    {
        ...
        [ListCount(5)]
        [Pos(6)]
        public virtual List<Loop_0100_222> Loop0100 { get; set; }
        [DataMember]
        [Required]
        [ListCount(999)]
        [Pos(7)]
        public virtual List<Loop_2000_222> Loop2000 { get; set; }
        /// <summary>
