namespace EdiFabric.Templates.X12007010
{
    ...
    public class Loop_LIN_325
    {
        ...
        [ListCount(10)]
        [Pos(5)]
        public virtual List<Loop_H1_325> LoopH1 { get; set; }
        /// <summary>
        // Item Packing Detail
        /// </summary>
        [DataMember]
    ...
    public class Loop_MBL_325
    {
        ...
        [ListCount(6)]
        [Pos(6)]
        public virtual List<Loop_N1_325> LoopN1 { get; set; }
        [DataMember]
        [Required]
        [ListCount(999)]
        [Pos(7)]
        public virtual List<Loop_LIN_325> LoopLIN { get; set; }
    }
    ...
    public class TS325 : EdiMessage
    {
        ...
        [ListCount(999)]
        [Pos(12)]
        public virtual List<Loop_MBL_325> LoopMBL { get; set; }
        /// <summary>
