namespace EdiFabric.Templates.X12007010
{
    ...
    public class Loop_L0_410
    {
        ...
        [ListCount(10)]
        [Pos(3)]
        public virtual List<Loop_L1_410> LoopL1 { get; set; }
        [DataMember]
        [ListCount(30)]
        [Pos(4)]
        public virtual List<Loop_PI_410> LoopPI { get; set; }
    }
    
    [Serializable()]
    [DataContract()]
    [Group(typeof(L1))]
    public class Loop_L1_410
    {
    ...
    public class Loop_LX_410
    {
        ...
        [ListCount(25)]
        [Pos(3)]
        public virtual List<Loop_L0_410> LoopL0 { get; set; }
    }
    ...
    public class TS410 : EdiMessage
    {
        ...
        [ListCount(500)]
        [Pos(7)]
        public virtual List<Loop_N7_410> LoopN7 { get; set; }
        /// <summary>
        // Waybill Reference
        /// </summary>
        [DataMember]
        ...
        [ListCount(15)]
        [Pos(11)]
        public virtual List<Loop_N1_410> LoopN1 { get; set; }
        [DataMember]
        [ListCount(12)]
        [Pos(12)]
        public virtual List<Loop_S1_410> LoopS1 { get; set; }
        /// <summary>
        // Route Information
        /// </summary>
        [DataMember]
        ...
        [ListCount(25)]
        [Pos(16)]
        public virtual List<Loop_LX_410> LoopLX { get; set; }
        [DataMember]
        [ListCount(64)]
        [Pos(17)]
        public virtual List<Loop_T1_410> LoopT1 { get; set; }
        /// <summary>
