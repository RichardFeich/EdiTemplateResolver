namespace EdiFabric.Templates.X12007010
{
    ...
    public class Loop_F9_422
    {
        ...
        [ListCount(9999)]
        [Pos(4)]
        public virtual List<Loop_SCR_422> LoopSCR { get; set; }
    }
    ...
    public class Loop_LS_422
    {
        ...
        [ListCount(9999)]
        [Pos(2)]
        public virtual List<Loop_N7_422> LoopN7 { get; set; }
        /// <summary>
        // Loop Trailer
        /// </summary>
        [DataMember]
    ...
    public class Loop_LX_422
    {
        ...
        [ListCount(31)]
        [Pos(3)]
        public virtual List<Loop_F9_422> LoopF9 { get; set; }
    }
    ...
    public class Loop_SCR_422
    {
        ...
        [ListCount(99)]
        [Pos(8)]
        public virtual List<Loop_LQ_422> LoopLQ { get; set; }
        [DataMember]
        [Pos(9)]
        public virtual Loop_LS_422 LoopLS { get; set; }
    }
    ...
    public class TS422 : EdiMessage
    {
        ...
        [ListCount(5)]
        [Pos(8)]
        public virtual List<Loop_N1_422> LoopN1 { get; set; }
        [DataMember]
        [Required]
        [ListCount(31)]
        [Pos(9)]
        public virtual List<Loop_LX_422> LoopLX { get; set; }
        /// <summary>
