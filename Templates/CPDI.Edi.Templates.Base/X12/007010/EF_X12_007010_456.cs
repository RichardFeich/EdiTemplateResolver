namespace EdiFabric.Templates.X12007010
{
    ...
    public class Loop_LX_456
    {
        ...
        [ListCount(12)]
        [Pos(14)]
        public virtual List<Loop_S1_456> LoopS1 { get; set; }
    }
    ...
    public class TS456 : EdiMessage
    {
        ...
        [ListCount(500)]
        [Pos(4)]
        public virtual List<Loop_LX_456> LoopLX { get; set; }
        [DataMember]
        [Pos(5)]
        public virtual Loop_IS1_456 LoopIS1 { get; set; }
        [DataMember]
        [ListCount(99)]
        [Pos(6)]
        public virtual List<Loop_ER_456> LoopER { get; set; }
        /// <summary>
