namespace EdiFabric.Templates.X12007010
{
    ...
    public class Loop_N11_818
    {
        ...
        [ListCount(999)]
        [Pos(4)]
        public virtual List<Loop_LIN_818> LoopLIN { get; set; }
        [DataMember]
        [ListCount(999)]
        [Pos(5)]
        public virtual List<Loop_NM1_818> LoopNM1 { get; set; }
    }
    ...
    public class Loop_NM1_818
    {
        ...
        [ListCount(99)]
        [Pos(7)]
        public virtual List<Loop_SAL_818> LoopSAL { get; set; }
        [DataMember]
        [ListCount(999)]
        [Pos(8)]
        public virtual List<Loop_LIN_818> LoopLIN { get; set; }
    ...
    public class TS818 : EdiMessage
    {
        ...
        [ListCount(999)]
        [Pos(4)]
        public virtual List<Loop_N11_818> LoopN11 { get; set; }
        /// <summary>
