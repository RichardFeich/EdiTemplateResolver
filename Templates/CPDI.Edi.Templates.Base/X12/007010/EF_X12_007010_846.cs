namespace EdiFabric.Templates.X12007010
{
    ...
    public class Loop_LIN_846
    {
        ...
        [ListCount(10)]
        [Pos(19)]
        public virtual List<Loop_LM_846> LoopLM { get; set; }
        [DataMember]
        [ListCount(1000)]
        [Pos(20)]
        public virtual List<Loop_SLN_846> LoopSLN { get; set; }
        [DataMember]
        [ListCount(99)]
        [Pos(21)]
        public virtual List<Loop_QTY_846> LoopQTY { get; set; }
        [DataMember]
        [ListCount(200)]
        [Pos(22)]
        public virtual List<Loop_N1_846> LoopN1 { get; set; }
    }
    ...
    public class Loop_LS_846
    {
        ...
        [ListCount(99999)]
        [Pos(2)]
        public virtual List<Loop_REF_846> LoopREF { get; set; }
        /// <summary>
        // Loop Trailer
        /// </summary>
        [DataMember]
    ...
    public class Loop_QTY_846
    {
        ...
        [ListCount(25)]
        [Pos(6)]
        public virtual List<Loop_SCH_846> LoopSCH { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(7)]
        public virtual List<Loop_LM_846> LoopLM { get; set; }
        [DataMember]
        [Pos(8)]
        public virtual Loop_LS_846 LoopLS { get; set; }
    }
    ...
    public class Loop_SLN_846
    {
        ...
        [ListCount(100)]
        [Pos(5)]
        public virtual List<Loop_MAN_846> LoopMAN { get; set; }
    }
    ...
    public class TS846 : EdiMessage
    {
        ...
        [ListCount(99999)]
        [Pos(10)]
        public virtual List<Loop_LIN_846> LoopLIN { get; set; }
        /// <summary>
        // Transaction Totals
        /// </summary>
        [DataMember]
