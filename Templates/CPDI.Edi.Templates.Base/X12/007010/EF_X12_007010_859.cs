namespace EdiFabric.Templates.X12007010
{
    ...
    public class Loop_LX_859
    {
        ...
        [ListCount(10)]
        [Pos(2)]
        public virtual List<Loop_N1_859> LoopN1 { get; set; }
        /// <summary>
        // Description
        /// </summary>
        [DataMember]
        ...
        [ListCount(10)]
        [Pos(4)]
        public virtual List<Loop_L0_859> LoopL0 { get; set; }
        /// <summary>
        // Tariff Reference
        /// </summary>
        [DataMember]
        ...
        [ListCount(3)]
        [Pos(20)]
        public virtual List<Loop_H1_859> LoopH1 { get; set; }
    }
    ...
    public class TS859 : EdiMessage
    {
        ...
        [ListCount(600)]
        [Pos(30)]
        public virtual List<Loop_N7_859> LoopN7 { get; set; }
        [DataMember]
        [ListCount(10)]
        [Pos(31)]
        public virtual List<Loop_N1_859> LoopN1 { get; set; }
        ...
        [ListCount(50)]
        [Pos(32)]
        public virtual List<Loop_S5_859> LoopS5 { get; set; }
        [DataMember]
        [Required]
        [ListCount(999)]
        [Pos(33)]
        public virtual List<Loop_LX_859> LoopLX { get; set; }
        /// <summary>
