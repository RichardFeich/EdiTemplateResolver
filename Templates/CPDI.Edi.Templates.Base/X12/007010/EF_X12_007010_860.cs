namespace EdiFabric.Templates.X12007010
{
    ...
    public class Loop_AMT_860
    {
        ...
        [ListCount(99999)]
        [Pos(5)]
        public virtual List<Loop_FA1_860> LoopFA1 { get; set; }
    }
    ...
    public class Loop_LS_860
    {
        ...
        [ListCount(99999)]
        [Pos(2)]
        public virtual List<Loop_LDT_860_2> LoopLDT { get; set; }
        /// <summary>
        // Loop Trailer
        /// </summary>
        [DataMember]
    ...
    public class Loop_POC_860
    {
        ...
        [ListCount(1000)]
        [Pos(10)]
        public virtual List<Loop_PID_860> LoopPID { get; set; }
        /// <summary>
        // Paperwork
        /// </summary>
        [DataMember]
        ...
        [ListCount(99999)]
        [Pos(16)]
        public virtual List<Loop_SAC_860> LoopSAC { get; set; }
        /// <summary>
        // Conditions of Sale
        /// </summary>
        [DataMember]
        ...
        [ListCount(99999)]
        [Pos(37)]
        public virtual List<Loop_QTY_860> LoopQTY { get; set; }
        [DataMember]
        [ListCount(200)]
        [Pos(38)]
        public virtual List<Loop_SCH_860> LoopSCH { get; set; }
        [DataMember]
        [ListCount(1000)]
        [Pos(39)]
        public virtual List<Loop_N9_860> LoopN9 { get; set; }
        [DataMember]
        [Pos(40)]
        public virtual Loop_LS_860 LoopLS { get; set; }
        [DataMember]
        [ListCount(200)]
        [Pos(41)]
        public virtual List<Loop_N1_860_2> LoopN1 { get; set; }
        [DataMember]
        [ListCount(1000)]
        [Pos(42)]
        public virtual List<Loop_SLN_860> LoopSLN { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(43)]
        public virtual List<Loop_AMT_860_2> LoopAMT { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(44)]
        public virtual List<Loop_LM_860> LoopLM { get; set; }
    }
    ...
    public class Loop_SLN_860
    {
        ...
        [ListCount(99999)]
        [Pos(16)]
        public virtual List<Loop_N9_860_3> LoopN9 { get; set; }
        [DataMember]
        [ListCount(10)]
        [Pos(17)]
        public virtual List<Loop_N1_860_3> LoopN1 { get; set; }
    }
    ...
    public class Loop_SPI_860
    {
        ...
        [ListCount(99999)]
        [Pos(5)]
        public virtual List<Loop_N1_860_4> LoopN1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(6)]
        public virtual List<Loop_CB1_860> LoopCB1 { get; set; }
    }
    ...
    public class TS860 : EdiMessage
    {
        ...
        [ListCount(99999)]
        [Pos(31)]
        public virtual List<Loop_LDT_860> LoopLDT { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(32)]
        public virtual List<Loop_AMT_860> LoopAMT { get; set; }
        [DataMember]
        [ListCount(1000)]
        [Pos(33)]
        public virtual List<Loop_N9_860> LoopN9 { get; set; }
        ...
        [ListCount(200)]
        [Pos(34)]
        public virtual List<Loop_N1_860> LoopN1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(35)]
        public virtual List<Loop_LM_860> LoopLM { get; set; }
        ...
        [ListCount(99999)]
        [Pos(36)]
        public virtual List<Loop_SPI_860> LoopSPI { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(37)]
        public virtual List<Loop_ADV_860> LoopADV { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(38)]
        public virtual List<Loop_POC_860> LoopPOC { get; set; }
        [DataMember]
        [Pos(39)]
        public virtual Loop_CTT_860 LoopCTT { get; set; }
        /// <summary>
