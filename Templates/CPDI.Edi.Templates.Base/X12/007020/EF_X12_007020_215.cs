namespace EdiFabric.Templates.X12007020
{
    ...
    public class Loop_0200_215
    {
        ...
        [ListCount(10)]
        [Pos(9)]
        public virtual List<Loop_0220_215> Loop0220 { get; set; }
        [DataMember]
        [Required]
        [ListCount(999999)]
        [Pos(10)]
        public virtual List<Loop_0240_215> Loop0240 { get; set; }
        [DataMember]
        [ListCount(999999)]
        [Pos(11)]
        public virtual List<Loop_0260_215> Loop0260 { get; set; }
    }

    [Serializable()]
    [DataContract()]
    [Group(typeof(N1))]
    public class Loop_0220_215
    {
    ...
    public class Loop_0240_215
    {
        ...
        [ListCount(999999)]
        [Pos(9)]
        public virtual List<Loop_0250_215> Loop0250 { get; set; }
    }

    [Serializable()]
    [DataContract()]
    [Group(typeof(N1))]
    public class Loop_0250_215
    {
    ...
    public class Loop_0260_215
    {
        ...
        [ListCount(999999)]
        [Pos(10)]
        public virtual List<Loop_0280_215> Loop0280 { get; set; }
    }

    [Serializable()]
    [DataContract()]
    [Group(typeof(SLN))]
    public class Loop_0280_215
    {
    ...
    public class TS215 : EdiMessage
    {
        ...
        [Required]
        [Pos(6)]
        public virtual Loop_N1_215 LoopN1 { get; set; }
        [DataMember]
        [Required]
        [ListCount(999999)]
        [Pos(7)]
        public virtual List<Loop_0200_215> Loop0200 { get; set; }
        /// <summary>
