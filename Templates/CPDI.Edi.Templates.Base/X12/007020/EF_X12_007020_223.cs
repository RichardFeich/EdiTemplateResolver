namespace EdiFabric.Templates.X12007020
{
    ...
    public class Loop_4000_223
    {
        ...
        [ListCount(9999)]
        [Pos(2)]
        public virtual List<Loop_4100_223> Loop4100 { get; set; }
        [DataMember]
        [Required]
        [ListCount(9999)]
        [Pos(3)]
        public virtual List<Loop_4500_223> Loop4500 { get; set; }
    }

    [Serializable()]
    [DataContract()]
    [Group(typeof(OID))]
    public class Loop_4100_223
    {
    ...
    public class Loop_4500_223
    {
        ...
        [DataMember]
        [Pos(7)]
        public virtual Loop_LS_223 LoopLS { get; set; }
        [DataMember]
        [ListCount(9999)]
        [Pos(8)]
        public virtual List<Loop_4520_223> Loop4520 { get; set; }
    }

    [Serializable()]
    [DataContract()]
    [Group(typeof(CSD))]
    public class Loop_4510_223
    {
    ...
    public class Loop_LS_223
    {
        ...
        [ListCount(9999)]
        [Pos(2)]
        public virtual List<Loop_4510_223> Loop4510 { get; set; }
        /// <summary>
        // Loop Trailer
        /// </summary>
        [DataMember]
    ...
    public class TS223 : EdiMessage
    {
        ...
        [ListCount(10)]
        [Pos(5)]
        public virtual List<Loop_0100_223> Loop0100 { get; set; }
        [DataMember]
        [ListCount(10)]
        [Pos(6)]
        public virtual List<Loop_0200_223> Loop0200 { get; set; }
        [DataMember]
        [ListCount(9999)]
        [Pos(7)]
        public virtual List<Loop_4000_223> Loop4000 { get; set; }
        /// <summary>
