namespace EdiFabric.Templates.X12007020
{
    ...
    public class Loop_EQD_228
    {
        ...
        [ListCount(10)]
        [Pos(7)]
        public virtual List<Loop_NM1_228> LoopNM1 { get; set; }
    }
    ...
    public class Loop_W2_228
    {
        ...
        [ListCount(10)]
        [Pos(5)]
        public virtual List<Loop_N1_228> LoopN1 { get; set; }
        [DataMember]
        [Required]
        [ListCount(1000)]
        [Pos(6)]
        public virtual List<Loop_EQD_228> LoopEQD { get; set; }
    }
    ...
    public class TS228 : EdiMessage
    {
        ...
        [ListCount(1000)]
        [Pos(4)]
        public virtual List<Loop_W2_228> LoopW2 { get; set; }
        /// <summary>
