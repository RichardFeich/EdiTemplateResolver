namespace EdiFabric.Templates.X12007020
{
    ...
    public class Loop_AMT_362
    {
        ...
        [ListCount(99999)]
        [Pos(3)]
        public virtual List<Loop_LQ_362> LoopLQ { get; set; }
    }
    ...
    public class Loop_L5_362
    {
        ...
        [ListCount(5)]
        [Pos(9)]
        public virtual List<Loop_R4_362> LoopR4 { get; set; }
        [DataMember]
        [Required]
        [ListCount(9)]
        [Pos(10)]
        public virtual List<Loop_AMT_362> LoopAMT { get; set; }
    }
    ...
    public class TS362 : EdiMessage
    {
        ...
        [ListCount(99999)]
        [Pos(8)]
        public virtual List<Loop_L5_362> LoopL5 { get; set; }
        /// <summary>
