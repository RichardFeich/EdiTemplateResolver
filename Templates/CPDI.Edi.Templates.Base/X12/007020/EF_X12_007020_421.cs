namespace EdiFabric.Templates.X12007020
{
    ...
    public class Loop_LH1_421
    {
        ...
        [ListCount(10)]
        [Pos(10)]
        public virtual List<Loop_N1_421> LoopN1 { get; set; }
    }
    ...
    public class Loop_LS_421
    {
        ...
        [ListCount(1000)]
        [Pos(2)]
        public virtual List<Loop_LH1_421> LoopLH1 { get; set; }
        /// <summary>
        // Loop Trailer
        /// </summary>
        [DataMember]
    ...
    public class TS421 : EdiMessage
    {
        ...
        [ListCount(12)]
        [Pos(19)]
        public virtual List<Loop_S1_421> LoopS1 { get; set; }
        [DataMember]
        [Pos(20)]
        public virtual Loop_LS_421 LoopLS { get; set; }
        /// <summary>
        // Administrative Communications Contact
        /// </summary>
        [DataMember]
