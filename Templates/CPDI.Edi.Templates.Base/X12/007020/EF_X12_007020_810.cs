namespace EdiFabric.Templates.X12007020
{
    ...
    public class Loop_IT1_810
    {
        ...
        [ListCount(1000)]
        [Pos(10)]
        public virtual List<Loop_PID_810> LoopPID { get; set; }
        /// <summary>
        // Paperwork
        /// </summary>
        [DataMember]
        ...
        [ListCount(99999)]
        [Pos(23)]
        public virtual List<Loop_SAC_810_2> LoopSAC { get; set; }
        [DataMember]
        [ListCount(1000)]
        [Pos(24)]
        public virtual List<Loop_SLN_810> LoopSLN { get; set; }
        [DataMember]
        [ListCount(200)]
        [Pos(25)]
        public virtual List<Loop_N1_810> LoopN1 { get; set; }
        [DataMember]
        [ListCount(10)]
        [Pos(26)]
        public virtual List<Loop_LM_810> LoopLM { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(27)]
        public virtual List<Loop_V1_810> LoopV1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(28)]
        public virtual List<Loop_FA1_810> LoopFA1 { get; set; }
    }
    ...
    public class Loop_SAC_810
    {
        ...
        [ListCount(99999)]
        [Pos(3)]
        public virtual List<Loop_TXI_810> LoopTXI { get; set; }
    }
    ...
    public class TS810 : EdiMessage
    {
        ...
        [DataMember]
        [Pos(23)]
        public virtual Loop_N9_810 LoopN9 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(24)]
        public virtual List<Loop_V1_810> LoopV1 { get; set; }
        ...
        [ListCount(99999)]
        [Pos(26)]
        public virtual List<Loop_IT1_810> LoopIT1 { get; set; }
        /// <summary>
        ...
        [ListCount(99999)]
        [Pos(31)]
        public virtual List<Loop_SAC_810> LoopSAC { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(32)]
        public virtual List<Loop_ISS_810> LoopISS { get; set; }
        /// <summary>
        // Transaction Totals
        /// </summary>
        [DataMember]
