namespace EdiFabric.Templates.X12007020
{
    ...
    public class Loop_2000_832
    {
        ...
        [ListCount(99999)]
        [Pos(29)]
        public virtual List<Loop_2100_832> Loop2100 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(30)]
        public virtual List<Loop_2200_832> Loop2200 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(31)]
        public virtual List<Loop_2300_832> Loop2300 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(32)]
        public virtual List<Loop_2400_832> Loop2400 { get; set; }
        [DataMember]
        [ListCount(20)]
        [Pos(33)]
        public virtual List<Loop_2500_832> Loop2500 { get; set; }
        [DataMember]
        [Pos(34)]
        ...
        [ListCount(99999)]
        [Pos(35)]
        public virtual List<Loop_2610_832> Loop2610 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(36)]
        public virtual List<Loop_2800_832> Loop2800 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(37)]
        public virtual List<Loop_2900_832> Loop2900 { get; set; }
    }

    [Serializable()]
    [DataContract()]
    [Group(typeof(TRT))]
    public class Loop_2100_832
    {
    ...
    public class Loop_2200_832
    {
        ...
        [ListCount(99999)]
        [Pos(14)]
        public virtual List<Loop_2210_832> Loop2210 { get; set; }
        [DataMember]
        [Pos(15)]
    ...
    public class Loop_2610_832
    {
        ...
        [ListCount(99999)]
        [Pos(2)]
        public virtual List<Loop_2710_832> Loop2710 { get; set; }
    }

    [Serializable()]
    [DataContract()]
    [Group(typeof(LQ))]
    public class Loop_2710_832
    {
        ...
        [ListCount(99999)]
        [Pos(5)]
        public virtual List<Loop_2711_832> Loop2711 { get; set; }
    }

    [Serializable()]
    [DataContract()]
    [Group(typeof(PID))]
    public class Loop_2711_832
    {
    ...
    public class Loop_2800_832
    {
        ...
        [ListCount(99999)]
        [Pos(13)]
        public virtual List<Loop_2810_832> Loop2810 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(14)]
        public virtual List<Loop_2820_832> Loop2820 { get; set; }
    }

    [Serializable()]
    [DataContract()]
    [Group(typeof(LM))]
    public class Loop_2810_832
    {
    ...
    public class Loop_LS_832
    {
        ...
        [ListCount(99999)]
        [Pos(2)]
        public virtual List<Loop_2220_832> Loop2220 { get; set; }
        /// <summary>
        // Loop Trailer
        /// </summary>
        [DataMember]
    ...
    public class Loop_LS_832_2
    {
        ...
        [ListCount(99999)]
        [Pos(2)]
        public virtual List<Loop_2230_832> Loop2230 { get; set; }
        /// <summary>
        // Loop Trailer
        /// </summary>
        [DataMember]
    ...
    public class TS832 : EdiMessage
    {
        ...
        [ListCount(99999)]
        [Pos(23)]
        public virtual List<Loop_1000_832> Loop1000 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(24)]
        public virtual List<Loop_1100_832> Loop1100 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(25)]
        public virtual List<Loop_1200_832> Loop1200 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(26)]
        public virtual List<Loop_1300_832> Loop1300 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(27)]
        public virtual List<Loop_2000_832> Loop2000 { get; set; }
        /// <summary>
        // Transaction Totals
        /// </summary>
        [DataMember]
