namespace EdiFabric.Templates.X12007020
{
    ...
    public class Loop_PO1_855
    {
        ...
        [ListCount(1000)]
        [Pos(9)]
        public virtual List<Loop_PID_855> LoopPID { get; set; }
        /// <summary>
        // Paperwork
        /// </summary>
        [DataMember]
        ...
        [ListCount(99999)]
        [Pos(14)]
        public virtual List<Loop_SAC_855> LoopSAC { get; set; }
        /// <summary>
        // Conditions of Sale
        /// </summary>
        [DataMember]
        ...
        [ListCount(104)]
        [Pos(29)]
        public virtual List<Loop_ACK_855> LoopACK { get; set; }
        /// <summary>
        ...
        [ListCount(99999)]
        [Pos(34)]
        public virtual List<Loop_QTY_855> LoopQTY { get; set; }
        [DataMember]
        [ListCount(200)]
        [Pos(35)]
        public virtual List<Loop_PKG_855> LoopPKG { get; set; }
        [DataMember]
        [ListCount(200)]
        [Pos(36)]
        public virtual List<Loop_SCH_855> LoopSCH { get; set; }
        [DataMember]
        [ListCount(1000)]
        [Pos(37)]
        public virtual List<Loop_N9_855> LoopN9 { get; set; }
        [DataMember]
        [ListCount(200)]
        [Pos(38)]
        public virtual List<Loop_N1_855_2> LoopN1 { get; set; }
        [DataMember]
        [ListCount(1000)]
        [Pos(39)]
        public virtual List<Loop_SLN_855> LoopSLN { get; set; }
    }
    ...
    public class Loop_SLN_855
    {
        ...
        [ListCount(99999)]
        [Pos(16)]
        public virtual List<Loop_N9_855_3> LoopN9 { get; set; }
        [DataMember]
        [ListCount(10)]
        [Pos(17)]
        public virtual List<Loop_N1_855_3> LoopN1 { get; set; }
    }
    ...
    public class TS855 : EdiMessage
    {
        ...
        [ListCount(99999)]
        [Pos(31)]
        public virtual List<Loop_N1_855> LoopN1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(32)]
        public virtual List<Loop_ADV_855> LoopADV { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(33)]
        public virtual List<Loop_PO1_855> LoopPO1 { get; set; }
        [DataMember]
        [Pos(34)]
        public virtual Loop_CTT_855 LoopCTT { get; set; }
        /// <summary>
