namespace EdiFabric.Templates.X12007020
{
    ...
    public class Loop_RCD_861
    {
        ...
        [ListCount(10)]
        [Pos(19)]
        public virtual List<Loop_LM_861> LoopLM { get; set; }
        [DataMember]
        [ListCount(100)]
        [Pos(20)]
        public virtual List<Loop_SLN_861> LoopSLN { get; set; }
        [DataMember]
        [ListCount(200)]
        [Pos(21)]
        public virtual List<Loop_N1_861> LoopN1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(22)]
        public virtual List<Loop_FA1_861> LoopFA1 { get; set; }
    }
    ...
    public class TS861 : EdiMessage
    {
        ...
        [ListCount(99999)]
        [Pos(16)]
        public virtual List<Loop_RCD_861> LoopRCD { get; set; }
        /// <summary>
        // Transaction Totals
        /// </summary>
        [DataMember]
