namespace EdiFabric.Templates.X12007020
{
    ...
    public class Loop_0200_882
    {
        ...
        [ListCount(99)]
        [Pos(2)]
        public virtual List<Loop_0210_882> Loop0210 { get; set; }
        /// <summary>
        // Terms of Sale
        /// </summary>
        [DataMember]
    ...
    public class TS882 : EdiMessage
    {
        ...
        [ListCount(10)]
        [Pos(3)]
        public virtual List<Loop_0100_882> Loop0100 { get; set; }
        /// <summary>
        ...
        [ListCount(9999)]
        [Pos(7)]
        public virtual List<Loop_0200_882> Loop0200 { get; set; }
        /// <summary>
        // Statement Total
        /// </summary>
        [DataMember]
