namespace EdiFabric.Templates.X12007020
{
    ...
    public class Loop_0100_885
    {
        ...
        [ListCount(99999)]
        [Pos(16)]
        public virtual List<Loop_0110_885> Loop0110 { get; set; }
    }

    [Serializable()]
    [DataContract()]
    [Group(typeof(LM))]
    public class Loop_0110_885
    {
    ...
    public class TS885 : EdiMessage
    {
        ...
        [ListCount(99999)]
        [Pos(5)]
        public virtual List<Loop_0100_885> Loop0100 { get; set; }
        /// <summary>
