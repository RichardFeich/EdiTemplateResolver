namespace EdiFabric.Templates.X12007020
{
    ...
    public class Loop_0100_886
    {
        ...
        [ListCount(150)]
        [Pos(3)]
        public virtual List<Loop_0110_886> Loop0110 { get; set; }
    }

    [Serializable()]
    [DataContract()]
    [Group(typeof(N1))]
    public class Loop_0110_886
    {
        ...
        [ListCount(1000)]
        [Pos(4)]
        public virtual List<Loop_0111_886> Loop0111 { get; set; }
    }

    [Serializable()]
    [DataContract()]
    [Group(typeof(G28))]
    public class Loop_0111_886
    {
    ...
    public class TS886 : EdiMessage
    {
        ...
        [ListCount(5000)]
        [Pos(4)]
        public virtual List<Loop_0100_886> Loop0100 { get; set; }
        /// <summary>
