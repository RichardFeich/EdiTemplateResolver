namespace EdiFabric.Templates.X12007030
{
    ...
    public class Loop_HL_105
    {
        ...
        [ListCount(99999)]
        [Pos(3)]
        public virtual List<Loop_LM_105> LoopLM { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(4)]
        public virtual List<Loop_NM1_105_2> LoopNM1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(5)]
        public virtual List<Loop_EFI_105> LoopEFI { get; set; }
    }
    ...
    public class Loop_LQ_105
    {
        ...
        [ListCount(99999)]
        [Pos(13)]
        public virtual List<Loop_REF_105_2> LoopREF { get; set; }
    }
    ...
    public class Loop_NM1_105_2
    {
        ...
        [ListCount(99999)]
        [Pos(13)]
        public virtual List<Loop_AMT_105_2> LoopAMT { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(14)]
        public virtual List<Loop_NX2_105> LoopNX2 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(15)]
        public virtual List<Loop_REF_105> LoopREF { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(16)]
        public virtual List<Loop_LX_105> LoopLX { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(17)]
        public virtual List<Loop_LM_105> LoopLM { get; set; }
    ...
    public class TS105 : EdiMessage
    {
        ...
        [ListCount(99999)]
        [Pos(6)]
        public virtual List<Loop_AMT_105> LoopAMT { get; set; }
        [DataMember]
        [Required]
        [ListCount(99999)]
        [Pos(7)]
        public virtual List<Loop_NM1_105> LoopNM1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(8)]
        public virtual List<Loop_LM_105> LoopLM { get; set; }
        ...
        [ListCount(99999)]
        [Pos(9)]
        public virtual List<Loop_HL_105> LoopHL { get; set; }
        /// <summary>
