namespace EdiFabric.Templates.X12007030
{
    ...
    public class Loop_IN1_138
    {
        ...
        [ListCount(10)]
        [Pos(13)]
        public virtual List<Loop_EMS_138> LoopEMS { get; set; }
    }
    ...
    public class Loop_PCL_138
    {
        ...
        [ListCount(10)]
        [Pos(6)]
        public virtual List<Loop_DEG_138_2> LoopDEG { get; set; }
    }
    ...
    public class Loop_SBT_138
    {
        ...
        [ListCount(99999)]
        [Pos(4)]
        public virtual List<Loop_RAP_138> LoopRAP { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(5)]
        public virtual List<Loop_SCA_138> LoopSCA { get; set; }
        [DataMember]
        [Pos(6)]
        public virtual Loop_N1_138 LoopN1 { get; set; }
    }
    ...
    public class Loop_SST_138
    {
        ...
        [DataMember]
        [Pos(6)]
        public virtual Loop_N1_138_2 LoopN1 { get; set; }
    }
    ...
    public class Loop_TST_138
    {
        ...
        [ListCount(99999)]
        [Pos(2)]
        public virtual List<Loop_SBT_138> LoopSBT { get; set; }
    }
    ...
    public class TS138 : EdiMessage
    {
        ...
        [ListCount(2)]
        [Pos(5)]
        public virtual List<Loop_N1_138> LoopN1 { get; set; }
        [DataMember]
        [Required]
        [ListCount(10)]
        [Pos(6)]
        public virtual List<Loop_IN1_138> LoopIN1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(7)]
        public virtual List<Loop_TST_138> LoopTST { get; set; }
        [DataMember]
        [ListCount(5)]
        [Pos(8)]
        public virtual List<Loop_DEG_138> LoopDEG { get; set; }
        [DataMember]
        [ListCount(10)]
        [Pos(9)]
        public virtual List<Loop_SST_138> LoopSST { get; set; }
        [DataMember]
        [ListCount(25)]
        [Pos(10)]
        public virtual List<Loop_PCL_138> LoopPCL { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(11)]
        public virtual List<Loop_ATV_138> LoopATV { get; set; }
        /// <summary>
