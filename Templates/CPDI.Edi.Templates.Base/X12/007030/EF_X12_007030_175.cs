namespace EdiFabric.Templates.X12007030
{
    ...
    public class Loop_CDS_175
    {
        ...
        [DataMember]
        [Pos(4)]
        public virtual Loop_LS_175 LoopLS { get; set; }
    }
    ...
    public class Loop_CED_175
    {
        ...
        [ListCount(99999)]
        [Pos(11)]
        public virtual List<Loop_LM_175> LoopLM { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(12)]
        public virtual List<Loop_NM1_175> LoopNM1 { get; set; }
    }
    ...
    public class Loop_LS_175
    {
        ...
        [ListCount(99999)]
        [Pos(2)]
        public virtual List<Loop_CED_175> LoopCED { get; set; }
        /// <summary>
        // Loop Trailer
        /// </summary>
        [DataMember]
    ...
    public class Loop_NM1_175
    {
        ...
        [ListCount(99999)]
        [Pos(11)]
        public virtual List<Loop_LX_175> LoopLX { get; set; }
    }
    ...
    public class TS175 : EdiMessage
    {
        ...
        [ListCount(99999)]
        [Pos(4)]
        public virtual List<Loop_CDS_175> LoopCDS { get; set; }
        /// <summary>
