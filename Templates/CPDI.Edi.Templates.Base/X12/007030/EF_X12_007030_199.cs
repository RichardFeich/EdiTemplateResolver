namespace EdiFabric.Templates.X12007030
{
    ...
    public class Loop_FGS_199
    {
        ...
        [ListCount(99999)]
        [Pos(2)]
        public virtual List<Loop_AMT_199> LoopAMT { get; set; }
    }
    ...
    public class Loop_LX_199
    {
        ...
        [ListCount(99999)]
        [Pos(8)]
        public virtual List<Loop_NX1_199> LoopNX1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(9)]
        public virtual List<Loop_IN1_199> LoopIN1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(10)]
        public virtual List<Loop_FGS_199> LoopFGS { get; set; }
    }
    ...
    public class TS199 : EdiMessage
    {
        ...
        [ListCount(5)]
        [Pos(3)]
        public virtual List<Loop_N1_199> LoopN1 { get; set; }
        [DataMember]
        [Required]
        [ListCount(99999)]
        [Pos(4)]
        public virtual List<Loop_LX_199> LoopLX { get; set; }
        /// <summary>
