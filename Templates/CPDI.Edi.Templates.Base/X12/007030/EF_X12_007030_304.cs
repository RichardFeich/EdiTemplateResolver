namespace EdiFabric.Templates.X12007030
{
    ...
    public class Loop_L0_304
    {
        ...
        [ListCount(100)]
        [Pos(4)]
        public virtual List<Loop_PO4_304> LoopPO4 { get; set; }
        /// <summary>
        ...
        [ListCount(3)]
        [Pos(8)]
        public virtual List<Loop_PAL_304> LoopPAL { get; set; }
        [DataMember]
        [Pos(9)]
        public virtual Loop_CTP_304 LoopCTP { get; set; }
        /// <summary>
        // Description
        /// </summary>
        [DataMember]
        ...
        [ListCount(20)]
        [Pos(14)]
        public virtual List<Loop_L1_304> LoopL1 { get; set; }
        /// <summary>
        // Tariff Reference
        /// </summary>
        [DataMember]
        ...
        [ListCount(10)]
        [Pos(16)]
        public virtual List<Loop_SAC_304> LoopSAC { get; set; }
        [DataMember]
        [ListCount(10)]
        [Pos(17)]
        public virtual List<Loop_L9_304> LoopL9 { get; set; }
        /// <summary>
        // Export License
        /// </summary>
        [DataMember]
        ...
        [ListCount(20)]
        [Pos(20)]
        public virtual List<Loop_C8_304> LoopC8 { get; set; }
        [DataMember]
        [ListCount(10)]
        [Pos(21)]
        public virtual List<Loop_H1_304> LoopH1 { get; set; }
        [DataMember]
        [ListCount(1000)]
        [Pos(22)]
        public virtual List<Loop_LH1_304> LoopLH1 { get; set; }
        [DataMember]
        [ListCount(10)]
        [Pos(23)]
        public virtual List<Loop_N1_304> LoopN1 { get; set; }
    }
    ...
    public class Loop_L3_304
    {
        ...
        [DataMember]
        [Pos(7)]
        public virtual Loop_TDS_304 LoopTDS { get; set; }
        [DataMember]
        [ListCount(10)]
        [Pos(8)]
        public virtual List<Loop_SAC_304> LoopSAC { get; set; }
    ...
    public class Loop_LX_304
    {
        ...
        [ListCount(999)]
        [Pos(3)]
        public virtual List<Loop_N7_304> LoopN7 { get; set; }
        /// <summary>
        // Business Instructions and Reference Number
        /// </summary>
        [DataMember]
        ...
        [ListCount(120)]
        [Pos(7)]
        public virtual List<Loop_L0_304> LoopL0 { get; set; }
    }
    ...
    public class TS304 : EdiMessage
    {
        ...
        [ListCount(5)]
        [Pos(14)]
        public virtual List<Loop_M1_304> LoopM1 { get; set; }
        /// <summary>
        ...
        [ListCount(20)]
        [Pos(20)]
        public virtual List<Loop_R4_304> LoopR4 { get; set; }
        /// <summary>
        ...
        [ListCount(999)]
        [Pos(30)]
        public virtual List<Loop_LX_304> LoopLX { get; set; }
        [DataMember]
        [Pos(31)]
        public virtual Loop_L3_304 LoopL3 { get; set; }
        /// <summary>
