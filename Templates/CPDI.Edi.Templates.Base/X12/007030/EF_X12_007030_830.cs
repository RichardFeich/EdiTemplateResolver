namespace EdiFabric.Templates.X12007030
{
    ...
    public class Loop_FST_830
    {
        ...
        [ListCount(99999)]
        [Pos(4)]
        public virtual List<Loop_LM_830> LoopLM { get; set; }
    }
    ...
    public class Loop_LIN_830
    {
        ...
        [ListCount(100)]
        [Pos(28)]
        public virtual List<Loop_SLN_830> LoopSLN { get; set; }
        [DataMember]
        [ListCount(200)]
        [Pos(29)]
        public virtual List<Loop_N1_830> LoopN1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(30)]
        public virtual List<Loop_LM_830> LoopLM { get; set; }
        ...
        [ListCount(99999)]
        [Pos(31)]
        public virtual List<Loop_FST_830> LoopFST { get; set; }
        [DataMember]
        [ListCount(260)]
        [Pos(32)]
        public virtual List<Loop_SDP_830> LoopSDP { get; set; }
        [DataMember]
        [ListCount(25)]
        [Pos(33)]
        public virtual List<Loop_SHP_830> LoopSHP { get; set; }
    }
    ...
    public class TS830 : EdiMessage
    {
        ...
        [ListCount(99999)]
        [Pos(25)]
        public virtual List<Loop_LIN_830> LoopLIN { get; set; }
        /// <summary>
        // Transaction Totals
        /// </summary>
        [DataMember]
