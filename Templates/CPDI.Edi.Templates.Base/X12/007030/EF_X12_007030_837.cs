namespace EdiFabric.Templates.X12007030
{
    ...
    public class Loop_2000_837
    {
        ...
        [ListCount(10)]
        [Pos(7)]
        public virtual List<Loop_2010_837> Loop2010 { get; set; }
        [DataMember]
        [ListCount(100)]
        [Pos(8)]
        public virtual List<Loop_2300_837> Loop2300 { get; set; }
    }

    [Serializable()]
    [DataContract()]
    [Group(typeof(NM1))]
    public class Loop_2010_837
    {
    ...
    public class Loop_2300_837
    {
        ...
        [ListCount(6)]
        [Pos(25)]
        public virtual List<Loop_2305_837> Loop2305 { get; set; }
        [DataMember]
        [ListCount(9)]
        [Pos(26)]
        public virtual List<Loop_2310_837> Loop2310 { get; set; }
        [DataMember]
        [ListCount(10)]
        [Pos(27)]
        public virtual List<Loop_2320_837> Loop2320 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(28)]
        public virtual List<Loop_2400_837> Loop2400 { get; set; }
    }

    [Serializable()]
    [DataContract()]
    [Group(typeof(CR7))]
    public class Loop_2305_837
    {
    ...
    public class Loop_2320_837
    {
        ...
        [ListCount(10)]
        [Pos(11)]
        public virtual List<Loop_2330_837> Loop2330 { get; set; }
    }

    [Serializable()]
    [DataContract()]
    [Group(typeof(NM1))]
    public class Loop_2330_837
    {
    ...
    public class Loop_2400_837
    {
        ...
        [ListCount(99999)]
        [Pos(31)]
        public virtual List<Loop_2410_837> Loop2410 { get; set; }
        [DataMember]
        [ListCount(10)]
        [Pos(32)]
        public virtual List<Loop_2420_837> Loop2420 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(33)]
        public virtual List<Loop_2430_837> Loop2430 { get; set; }
        [DataMember]
        [Pos(34)]
        public virtual Loop_LS_837 LoopLS { get; set; }
    }

    [Serializable()]
    [DataContract()]
    [Group(typeof(LIN))]
    public class Loop_2410_837
    {
    ...
    public class Loop_LS_837
    {
        ...
        [ListCount(99999)]
        [Pos(2)]
        public virtual List<Loop_2440_837> Loop2440 { get; set; }
        /// <summary>
        // Loop Trailer
        /// </summary>
        [DataMember]
    ...
    public class TS837 : EdiMessage
    {
        ...
        [ListCount(10)]
        [Pos(4)]
        public virtual List<Loop_1000_837> Loop1000 { get; set; }
        [DataMember]
        [Required]
        [ListCount(99999)]
        [Pos(5)]
        public virtual List<Loop_2000_837> Loop2000 { get; set; }
        /// <summary>
