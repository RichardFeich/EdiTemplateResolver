namespace EdiFabric.Templates.X12007030
{
    ...
    public class Loop_LDT_843_2
    {
        ...
        [ListCount(99999)]
        [Pos(4)]
        public virtual List<Loop_LM_843> LoopLM { get; set; }
    }
    ...
    public class Loop_N1_843_2
    {
        ...
        [ListCount(99999)]
        [Pos(17)]
        public virtual List<Loop_LDT_843_2> LoopLDT { get; set; }
    }
    ...
    public class Loop_PO1_843
    {
        ...
        [ListCount(1000)]
        [Pos(8)]
        public virtual List<Loop_PID_843> LoopPID { get; set; }
        /// <summary>
        // Paperwork
        /// </summary>
        [DataMember]
        ...
        [ListCount(99999)]
        [Pos(35)]
        public virtual List<Loop_QTY_843> LoopQTY { get; set; }
        [DataMember]
        [ListCount(104)]
        [Pos(36)]
        public virtual List<Loop_SCH_843> LoopSCH { get; set; }
        [DataMember]
        [ListCount(100)]
        [Pos(37)]
        public virtual List<Loop_CST_843> LoopCST { get; set; }
        [DataMember]
        [ListCount(1000)]
        [Pos(38)]
        public virtual List<Loop_SLN_843> LoopSLN { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(39)]
        public virtual List<Loop_PD_843> LoopPD { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(40)]
        public virtual List<Loop_LDT_843_2> LoopLDT { get; set; }
        ...
        [ListCount(1000)]
        [Pos(41)]
        public virtual List<Loop_N9_843> LoopN9 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(42)]
        public virtual List<Loop_N1_843_2> LoopN1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(43)]
        public virtual List<Loop_AMT_843> LoopAMT { get; set; }
    }
    ...
    public class TS843 : EdiMessage
    {
        ...
        [ListCount(10000)]
        [Pos(30)]
        public virtual List<Loop_N1_843> LoopN1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(31)]
        public virtual List<Loop_AMT_843> LoopAMT { get; set; }
        ...
        [ListCount(99999)]
        [Pos(32)]
        public virtual List<Loop_ADV_843> LoopADV { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(33)]
        public virtual List<Loop_LM_843> LoopLM { get; set; }
        ...
        [ListCount(99999)]
        [Pos(34)]
        public virtual List<Loop_LDT_843> LoopLDT { get; set; }
        [DataMember]
        [ListCount(100000)]
        [Pos(35)]
        public virtual List<Loop_PO1_843> LoopPO1 { get; set; }
        [DataMember]
        [Pos(36)]
        public virtual Loop_CTT_843 LoopCTT { get; set; }
        /// <summary>
