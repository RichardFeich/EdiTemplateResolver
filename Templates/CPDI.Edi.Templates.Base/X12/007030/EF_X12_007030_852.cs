namespace EdiFabric.Templates.X12007030
{
    ...
    public class Loop_LIN_852
    {
        ...
        [ListCount(99999)]
        [Pos(10)]
        public virtual List<Loop_ZA_852> LoopZA { get; set; }
    }
    ...
    public class Loop_ZA_852
    {
        ...
        [DataMember]
        [Pos(5)]
        public virtual Loop_G95_852 LoopG95 { get; set; }
    }
    ...
    public class TS852 : EdiMessage
    {
        ...
        [ListCount(200)]
        [Pos(7)]
        public virtual List<Loop_N1_852> LoopN1 { get; set; }
        [DataMember]
        [ListCount(999999)]
        [Pos(8)]
        public virtual List<Loop_LIN_852> LoopLIN { get; set; }
        /// <summary>
        // Transaction Totals
        /// </summary>
        [DataMember]
