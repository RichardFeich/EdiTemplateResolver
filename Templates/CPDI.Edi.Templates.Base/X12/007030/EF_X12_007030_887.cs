namespace EdiFabric.Templates.X12007030
{
    ...
    public class TS887 : EdiMessage
    {
        ...
        [ListCount(5)]
        [Pos(11)]
        public virtual List<Loop_0100_887> Loop0100 { get; set; }
        [DataMember]
        [ListCount(5)]
        [Pos(12)]
        public virtual List<Loop_0200_887> Loop0200 { get; set; }
        [DataMember]
        [ListCount(10)]
        [Pos(13)]
        public virtual List<Loop_0300_887> Loop0300 { get; set; }
        /// <summary>
