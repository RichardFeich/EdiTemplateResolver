namespace EdiFabric.Templates.X12007040
{
    ...
    public class Loop_API_198
    {
        ...
        [ListCount(99999)]
        [Pos(2)]
        public virtual List<Loop_N1_198_2> LoopN1 { get; set; }
    }
    ...
    public class Loop_FAA_198
    {
        ...
        [ListCount(99999)]
        [Pos(5)]
        public virtual List<Loop_DTP_198> LoopDTP { get; set; }
    }
    ...
    public class Loop_IN1_198
    {
        ...
        [ListCount(99999)]
        [Pos(6)]
        public virtual List<Loop_API_198> LoopAPI { get; set; }
    }
    ...
    public class Loop_N1_198_2
    {
        ...
        [ListCount(99999)]
        [Pos(9)]
        public virtual List<Loop_PWK_198> LoopPWK { get; set; }
    }
    ...
    public class Loop_PWK_198
    {
        ...
        [ListCount(99999)]
        [Pos(7)]
        public virtual List<Loop_AIN_198> LoopAIN { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(8)]
        public virtual List<Loop_NX1_198> LoopNX1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(9)]
        public virtual List<Loop_FAA_198> LoopFAA { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(10)]
        public virtual List<Loop_CDA_198> LoopCDA { get; set; }
    }
    ...
    public class TS198 : EdiMessage
    {
        ...
        [ListCount(99999)]
        [Pos(3)]
        public virtual List<Loop_N1_198> LoopN1 { get; set; }
        [DataMember]
        [Required]
        [ListCount(99999)]
        [Pos(4)]
        public virtual List<Loop_IN1_198> LoopIN1 { get; set; }
        /// <summary>
