namespace EdiFabric.Templates.X12007040
{
    ...
    public class Loop_2000_220
    {
        ...
        [ListCount(10)]
        [Pos(5)]
        public virtual List<Loop_2100_220> Loop2100 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(6)]
        public virtual List<Loop_2200_220> Loop2200 { get; set; }
    }

    [Serializable()]
    [DataContract()]
    [Group(typeof(N1))]
    public class Loop_2100_220
    {
    ...
    public class Loop_2200_220
    {
        ...
        [ListCount(99999)]
        [Pos(7)]
        public virtual List<Loop_2250_220> Loop2250 { get; set; }
    }

    [Serializable()]
    [DataContract()]
    [Group(typeof(LAD))]
    public class Loop_2250_220
    {
    ...
    public class TS220 : EdiMessage
    {
        ...
        [ListCount(99)]
        [Pos(8)]
        public virtual List<Loop_0500_220> Loop0500 { get; set; }
        [DataMember]
        [ListCount(99)]
        [Pos(9)]
        public virtual List<Loop_1000_220> Loop1000 { get; set; }
        [DataMember]
        [ListCount(99)]
        [Pos(10)]
        public virtual List<Loop_2000_220> Loop2000 { get; set; }
        /// <summary>
