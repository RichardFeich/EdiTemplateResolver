namespace EdiFabric.Templates.X12007040
{
    ...
    public class Loop_0100_227
    {
        ...
        [ListCount(99999)]
        [Pos(7)]
        public virtual List<Loop_0110_227> Loop0110 { get; set; }
    }

    [Serializable()]
    [DataContract()]
    [Group(typeof(N7))]
    public class Loop_0110_227
    {
    ...
    public class TS227 : EdiMessage
    {
        ...
        [ListCount(99999)]
        [Pos(3)]
        public virtual List<Loop_0100_227> Loop0100 { get; set; }
        /// <summary>
