namespace EdiFabric.Templates.X12007040
{
    ...
    public class Loop_BSF_244
    {
        ...
        [ListCount(99999)]
        [Pos(2)]
        public virtual List<Loop_NX2_244> LoopNX2 { get; set; }
        [DataMember]
        [Required]
        [ListCount(99999)]
        [Pos(3)]
        public virtual List<Loop_PID_244> LoopPID { get; set; }
    }
    ...
    public class Loop_N1_244
    {
        ...
        [ListCount(99999)]
        [Pos(3)]
        public virtual List<Loop_BSF_244> LoopBSF { get; set; }
    }
    ...
    public class Loop_NM1_244
    {
        ...
        [ListCount(99999)]
        [Pos(3)]
        public virtual List<Loop_N1_244> LoopN1 { get; set; }
    }
    ...
    public class TS244 : EdiMessage
    {
        ...
        [ListCount(99999)]
        [Pos(3)]
        public virtual List<Loop_NM1_244> LoopNM1 { get; set; }
        /// <summary>
