namespace EdiFabric.Templates.X12007040
{
    ...
    public class Loop_2000_271
    {
        ...
        [ListCount(99999)]
        [Pos(4)]
        public virtual List<Loop_2100_271> Loop2100 { get; set; }
    }

    [Serializable()]
    [DataContract()]
    [Group(typeof(NM1))]
    public class Loop_2100_271
    {
        ...
        [ListCount(99999)]
        [Pos(15)]
        public virtual List<Loop_2105_271> Loop2105 { get; set; }
    }

    [Serializable()]
    [DataContract()]
    [Group(typeof(LX))]
    public class Loop_2105_271
    {
        ...
        [ListCount(99999)]
        [Pos(3)]
        public virtual List<Loop_2110_271> Loop2110 { get; set; }
    }

    [Serializable()]
    [DataContract()]
    [Group(typeof(EB))]
    public class Loop_2110_271
    {
        ...
        [ListCount(20)]
        [Pos(2)]
        public virtual List<SBI> SBI { get; set; }
        /// <summary>
        ...
        [ListCount(99999)]
        [Pos(17)]
        public virtual List<Loop_2115_271> Loop2115 { get; set; }
        [DataMember]
        [Pos(18)]
    ...
    public class Loop_2115_271
    {
        ...
        [ListCount(99999)]
        [Pos(5)]
        public virtual List<Loop_2117_271> Loop2117 { get; set; }
    }

    [Serializable()]
    [DataContract()]
    [Group(typeof(LQ))]
    public class Loop_2117_271
    {
    ...
    public class Loop_LS_271
    {
        ...
        [ListCount(99999)]
        [Pos(2)]
        public virtual List<Loop_2120_271> Loop2120 { get; set; }
        /// <summary>
        // Loop Trailer
        /// </summary>
        [DataMember]
    ...
    public class TS271 : EdiMessage
    {
        ...
        [ListCount(99999)]
        [Pos(3)]
        public virtual List<Loop_2000_271> Loop2000 { get; set; }
        /// <summary>
