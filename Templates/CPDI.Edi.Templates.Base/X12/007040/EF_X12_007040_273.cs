namespace EdiFabric.Templates.X12007040
{
    ...
    public class Loop_ACT_273
    {
        ...
        [ListCount(99999)]
        [Pos(10)]
        public virtual List<Loop_LX_273> LoopLX { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(11)]
        public virtual List<Loop_MSG_273> LoopMSG { get; set; }
    }
    ...
    public class Loop_BLI_273
    {
        ...
        [ListCount(99999)]
        [Pos(10)]
        public virtual List<Loop_BEN_273> LoopBEN { get; set; }
    }
    ...
    public class Loop_ENT_273
    {
        ...
        [ListCount(99999)]
        [Pos(15)]
        public virtual List<Loop_LQ_273> LoopLQ { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(16)]
        public virtual List<Loop_BEN_273> LoopBEN { get; set; }
        ...
        [ListCount(99999)]
        [Pos(17)]
        public virtual List<Loop_BLI_273> LoopBLI { get; set; }
    }
    ...
    public class Loop_LQ_273
    {
        ...
        [ListCount(99999)]
        [Pos(6)]
        public virtual List<Loop_NM1_273_2> LoopNM1 { get; set; }
    }
    ...
    public class Loop_LX_273
    {
        ...
        [ListCount(99999)]
        [Pos(10)]
        public virtual List<Loop_ENT_273> LoopENT { get; set; }
    }
    ...
    public class TS273 : EdiMessage
    {
        ...
        [ListCount(2)]
        [Pos(5)]
        public virtual List<Loop_NM1_273> LoopNM1 { get; set; }
        [DataMember]
        [Required]
        [ListCount(99999)]
        [Pos(6)]
        public virtual List<Loop_ACT_273> LoopACT { get; set; }
        /// <summary>
