namespace EdiFabric.Templates.X12007040
{
    ...
    public class Loop_CS_527
    {
        ...
        [ListCount(25)]
        [Pos(6)]
        public virtual List<Loop_LM_527> LoopLM { get; set; }
    }
    ...
    public class Loop_LIN_527
    {
        ...
        [ListCount(99999)]
        [Pos(4)]
        public virtual List<Loop_RCD_527> LoopRCD { get; set; }
    }
    ...
    public class Loop_RCD_527
    {
        ...
        [ListCount(99999)]
        [Pos(10)]
        public virtual List<Loop_CS_527> LoopCS { get; set; }
        [DataMember]
        [ListCount(25)]
        [Pos(11)]
        public virtual List<Loop_N1_527_2> LoopN1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(12)]
        public virtual List<Loop_REF_527> LoopREF { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(13)]
        public virtual List<Loop_QTY_527> LoopQTY { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(14)]
        public virtual List<Loop_FA1_527> LoopFA1 { get; set; }
    }
    ...
    public class TS527 : EdiMessage
    {
        ...
        [ListCount(20)]
        [Pos(6)]
        public virtual List<Loop_N1_527> LoopN1 { get; set; }
        [DataMember]
        [Required]
        [ListCount(99999)]
        [Pos(7)]
        public virtual List<Loop_LIN_527> LoopLIN { get; set; }
        /// <summary>
