namespace EdiFabric.Templates.X12007040
{
    ...
    public class Loop_HL_561
    {
        ...
        [ListCount(99999)]
        [Pos(11)]
        public virtual List<Loop_FA1_561> LoopFA1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(12)]
        public virtual List<Loop_LM_561> LoopLM { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(13)]
        public virtual List<Loop_N1_561> LoopN1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(14)]
        public virtual List<Loop_SCH_561> LoopSCH { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(15)]
        public virtual List<Loop_RRE_561> LoopRRE { get; set; }
    }
    ...
    public class Loop_RRE_561
    {
        ...
        [Required]
        [Pos(1)]
        public virtual RRE RRE { get; set; }
        /// <summary>
    ...
    public class Loop_SCH_561
    {
        ...
        [ListCount(99999)]
        [Pos(2)]
        public virtual List<Loop_N1_561_3> LoopN1 { get; set; }
    }
    ...
    public class TS561 : EdiMessage
    {
        ...
        [ListCount(99999)]
        [Pos(6)]
        public virtual List<Loop_HL_561> LoopHL { get; set; }
        /// <summary>
        // Transaction Totals
        /// </summary>
        [DataMember]
