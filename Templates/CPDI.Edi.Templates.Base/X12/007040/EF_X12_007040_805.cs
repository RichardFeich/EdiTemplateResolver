namespace EdiFabric.Templates.X12007040
{
    ...
    public class Loop_CB1_805
    {
        ...
        [ListCount(99999)]
        [Pos(4)]
        public virtual List<Loop_N1_805_3> LoopN1 { get; set; }
    }
    ...
    public class Loop_PD_805
    {
        ...
        [ListCount(99999)]
        [Pos(6)]
        public virtual List<Loop_N1_805_2> LoopN1 { get; set; }
    }
    ...
    public class TS805 : EdiMessage
    {
        ...
        [ListCount(99999)]
        [Pos(6)]
        public virtual List<Loop_N1_805> LoopN1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(7)]
        public virtual List<Loop_CBS_805> LoopCBS { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(8)]
        public virtual List<Loop_CB1_805> LoopCB1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(9)]
        public virtual List<Loop_REF_805> LoopREF { get; set; }
        /// <summary>
        // Proposal Cost Logic
        /// </summary>
        [DataMember]
        ...
        [ListCount(99999)]
        [Pos(11)]
        public virtual List<Loop_HL_805> LoopHL { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(12)]
        public virtual List<Loop_PD_805> LoopPD { get; set; }
        [DataMember]
        [ListCount(2)]
        [Pos(13)]
        public virtual List<Loop_LX_805> LoopLX { get; set; }
        /// <summary>
