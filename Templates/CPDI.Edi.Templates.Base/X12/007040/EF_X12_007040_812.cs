namespace EdiFabric.Templates.X12007040
{
    ...
    public class Loop_CDD_812
    {
        ...
        [ListCount(25)]
        [Pos(6)]
        public virtual List<Loop_SAC_812> LoopSAC { get; set; }
        [DataMember]
        [ListCount(10)]
        [Pos(7)]
        public virtual List<Loop_LM_812> LoopLM { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(8)]
        public virtual List<Loop_N11_812> LoopN11 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(9)]
        public virtual List<Loop_FA1_812> LoopFA1 { get; set; }
        /// <summary>
        // Loop Header
        /// </summary>
        [DataMember]
        ...
        [ListCount(99999)]
        [Pos(11)]
        public virtual List<Loop_TXI_812> LoopTXI { get; set; }
        /// <summary>
        // Loop Trailer
        /// </summary>
        [DataMember]
    ...
    public class Loop_N11_812
    {
        ...
        [ListCount(99999)]
        [Pos(4)]
        public virtual List<Loop_N1_812_2> LoopN1 { get; set; }
    }
    ...
    public class TS812 : EdiMessage
    {
        ...
        [ListCount(200)]
        [Pos(11)]
        public virtual List<Loop_N1_812> LoopN1 { get; set; }
        [DataMember]
        [ListCount(10)]
        [Pos(12)]
        public virtual List<Loop_LM_812> LoopLM { get; set; }
        ...
        [ListCount(99999)]
        [Pos(15)]
        public virtual List<Loop_CDD_812> LoopCDD { get; set; }
        /// <summary>
