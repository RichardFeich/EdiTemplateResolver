namespace EdiFabric.Templates.X12007040
{
    ...
    public class Loop_ACT_822
    {
        ...
        [ListCount(99999)]
        [Pos(4)]
        public virtual List<Loop_RTE_822> LoopRTE { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(5)]
        public virtual List<Loop_LX_822> LoopLX { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(6)]
        public virtual List<Loop_SER_822> LoopSER { get; set; }
    }
    ...
    public class Loop_ENT_822
    {
        ...
        [ListCount(99999)]
        [Pos(2)]
        public virtual List<Loop_N1_822> LoopN1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(3)]
        public virtual List<Loop_ACT_822> LoopACT { get; set; }
    }
    ...
    public class TS822 : EdiMessage
    {
        ...
        [DataMember]
        [Pos(5)]
        public virtual Loop_N1_822 LoopN1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(6)]
        public virtual List<Loop_RTE_822> LoopRTE { get; set; }
        ...
        [ListCount(99999)]
        [Pos(7)]
        public virtual List<Loop_ENT_822> LoopENT { get; set; }
    }
}
