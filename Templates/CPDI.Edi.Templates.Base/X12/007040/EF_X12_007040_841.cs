namespace EdiFabric.Templates.X12007040
{
    ...
    public class Loop_CID_841
    {
        ...
        [ListCount(99999)]
        [Pos(8)]
        public virtual List<Loop_MEA_841> LoopMEA { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(9)]
        public virtual List<Loop_STA_841> LoopSTA { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(10)]
        public virtual List<Loop_CSF_841> LoopCSF { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(11)]
        public virtual List<Loop_EFI_841> LoopEFI { get; set; }
    }
    ...
    public class Loop_CSF_841
    {
        ...
        [DataMember]
        [Pos(2)]
        public virtual Loop_LS_841 LoopLS { get; set; }
    }
    ...
    public class Loop_HL_841
    {
        ...
        [ListCount(99999)]
        [Pos(2)]
        public virtual List<Loop_SPI_841_2> LoopSPI { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(3)]
        public virtual List<Loop_PID_841> LoopPID { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(4)]
        public virtual List<Loop_REF_841> LoopREF { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(5)]
        public virtual List<Loop_LX_841> LoopLX { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(6)]
        public virtual List<Loop_EFI_841> LoopEFI { get; set; }
        ...
        [ListCount(99999)]
        [Pos(7)]
        public virtual List<Loop_CID_841> LoopCID { get; set; }
    }
    ...
    public class Loop_LS_841
    {
        ...
        [ListCount(99999)]
        [Pos(2)]
        public virtual List<Loop_CID_841_2> LoopCID { get; set; }
        /// <summary>
        // Loop Trailer
        /// </summary>
        [DataMember]
    ...
    public class Loop_PID_841
    {
        ...
        [ListCount(99999)]
        [Pos(8)]
        public virtual List<Loop_PKG_841> LoopPKG { get; set; }
    }
    ...
    public class Loop_SPI_841
    {
        ...
        [ListCount(99999)]
        [Pos(9)]
        public virtual List<Loop_N1_841> LoopN1 { get; set; }
    }
    ...
    public class TS841 : EdiMessage
    {
        ...
        [ListCount(99999)]
        [Pos(2)]
        public virtual List<Loop_SPI_841> LoopSPI { get; set; }
        [DataMember]
        [Required]
        [ListCount(99999)]
        [Pos(3)]
        public virtual List<Loop_HL_841> LoopHL { get; set; }
        /// <summary>
