namespace EdiFabric.Templates.X12007040
{
    ...
    public class Loop_HL_856
    {
        ...
        [ListCount(12)]
        [Pos(13)]
        public virtual List<Loop_TD3_856> LoopTD3 { get; set; }
        /// <summary>
        ...
        [ListCount(100)]
        [Pos(18)]
        public virtual List<Loop_LH1_856> LoopLH1 { get; set; }
        [DataMember]
        [ListCount(200)]
        [Pos(19)]
        public virtual List<Loop_CLD_856> LoopCLD { get; set; }
        /// <summary>
        ...
        [ListCount(200)]
        [Pos(24)]
        public virtual List<Loop_N1_856> LoopN1 { get; set; }
        /// <summary>
        ...
        [ListCount(99999)]
        [Pos(28)]
        public virtual List<Loop_SAC_856> LoopSAC { get; set; }
        /// <summary>
        ...
        [ListCount(10)]
        [Pos(31)]
        public virtual List<Loop_LM_856> LoopLM { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(32)]
        public virtual List<Loop_V1_856> LoopV1 { get; set; }
    }
    ...
    public class TS856 : EdiMessage
    {
        ...
        [ListCount(200000)]
        [Pos(4)]
        public virtual List<Loop_HL_856> LoopHL { get; set; }
        /// <summary>
        // Transaction Totals
        /// </summary>
        [DataMember]
