namespace EdiFabric.Templates.X12007040
{
    ...
    public class Loop_HL_870
    {
        ...
        [ListCount(104)]
        [Pos(3)]
        public virtual List<Loop_ISR_870> LoopISR { get; set; }
        /// <summary>
        ...
        [ListCount(99999)]
        [Pos(7)]
        public virtual List<Loop_REF_870> LoopREF { get; set; }
        [DataMember]
        [ListCount(200)]
        [Pos(8)]
        public virtual List<Loop_N1_870_2> LoopN1 { get; set; }
        [DataMember]
        [ListCount(10)]
        [Pos(9)]
        public virtual List<Loop_LM_870> LoopLM { get; set; }
        [DataMember]
        [ListCount(1000)]
        [Pos(10)]
        public virtual List<Loop_PO1_870> LoopPO1 { get; set; }
    }
    ...
    public class Loop_PO1_870
    {
        ...
        [ListCount(104)]
        [Pos(8)]
        public virtual List<Loop_ISR_870_2> LoopISR { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(9)]
        public virtual List<Loop_LX_870> LoopLX { get; set; }
    }
    ...
    public class TS870 : EdiMessage
    {
        ...
        [ListCount(200)]
        [Pos(8)]
        public virtual List<Loop_N1_870> LoopN1 { get; set; }
        [DataMember]
        [ListCount(10)]
        [Pos(9)]
        public virtual List<Loop_LM_870> LoopLM { get; set; }
        ...
        [ListCount(1000)]
        [Pos(10)]
        public virtual List<Loop_HL_870> LoopHL { get; set; }
        /// <summary>
        // Transaction Totals
        /// </summary>
        [DataMember]
