namespace EdiFabric.Templates.X12003020
{
    ...
    public class Loop_D5_417
    {
        ...
        [ListCount(2)]
        [Pos(2)]
        public virtual List<D6> D6 { get; set; }
        /// <summary>
    ...
    public class Loop_F5_417
    {
        ...
        [ListCount(2)]
        [Pos(2)]
        public virtual List<F6> F6 { get; set; }
        /// <summary>
    ...
    public class TS417 : EdiMessage
    {
        ...
        [ListCount(2)]
        [Pos(22)]
        public virtual List<U2> U2 { get; set; }
        /// <summary>
        ...
        [ListCount(2)]
        [Pos(25)]
        public virtual List<U6> U6 { get; set; }
        /// <summary>
        /// Prior Origin City
        /// </summary>
        [DataMember]
        ...
        [ListCount(10)]
        [Pos(27)]
        public virtual List<Loop_F5_417> F5Loop { get; set; }
        /// <summary>
        /// Loop for Consignee's Third Party
        /// </summary>
        [DataMember]
        [ListCount(10)]
        [Pos(28)]
        public virtual List<Loop_D5_417> D5Loop { get; set; }
        /// <summary>
        /// Loop for Stop-off Name
        /// </summary>
        [DataMember]
