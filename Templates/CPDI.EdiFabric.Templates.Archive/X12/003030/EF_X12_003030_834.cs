namespace EdiFabric.Templates.X12003030
{
    ...
    /// <summary>
    /// Loop for Beneficiary Information
    /// </summary>
    [Serializable()]
    [DataContract()]
    [Group(typeof(BEN))]
    ...
    public class Loop_INS_834
    {
        ...
        [ListCount(10)]
        [Pos(16)]
        public virtual List<Loop_PER_834> PERLoop { get; set; }
        /// <summary>
        /// Loop for Health Coverage
        /// </summary>
        [DataMember]
    ...
    public class Loop_RP_834
    {
        ...
        [ListCount(5)]
        [Pos(5)]
        public virtual List<Loop_BEN_834_2> BENLoop { get; set; }
        /// <summary>
        /// Loop for Financial Contribution
        /// </summary>
        [DataMember]
