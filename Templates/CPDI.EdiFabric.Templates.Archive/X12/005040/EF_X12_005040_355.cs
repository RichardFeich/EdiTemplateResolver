namespace EdiFabric.Templates.X12005040
{
    ...
    /// <summary>
    /// Loop for Conveyance Insurance Information
    /// </summary>
    [Serializable()]
    [DataContract()]
    [Group(typeof(CII))]
    ...
    /// <summary>
    /// Loop for Demographic Information
    /// </summary>
    [Serializable()]
    [DataContract()]
    [Group(typeof(DMG))]
    ...
    public class Loop_M12_355
    {
        ...
        [ListCount(10)]
        [Pos(3)]
        public virtual List<Loop_R4_355> R4Loop { get; set; }
        /// <summary>
    ...
    public class Loop_NM1_355
    {
        ...
        [DataMember]
        [Pos(3)]
        public virtual Loop_DMG_355 DMGLoop { get; set; }
        /// <summary>
        /// Loop for Reference Information
        /// </summary>
        [DataMember]
        [Pos(4)]
        public virtual Loop_REF_355 REFLoop { get; set; }
        /// <summary>
        /// Loop for Party Location
        /// </summary>
        [DataMember]
        [Pos(5)]
        public virtual Loop_N3_355 N3Loop { get; set; }
        /// <summary>
        /// Loop for Geographic Location
        /// </summary>
        [DataMember]
    ...
    public class Loop_VEH_355
    {
        ...
        [DataMember]
        [Pos(3)]
        public virtual Loop_M7_355 M7Loop { get; set; }
        /// <summary>
        /// Loop for Conveyance Insurance Information
        /// </summary>
        [DataMember]
        [Pos(4)]
        public virtual Loop_CII_355 CIILoop { get; set; }
    }
    ...
    public class Loop_VID_355
    {
        ...
        [ListCount(5)]
        [Pos(6)]
        public virtual List<Loop_M7_355> M7Loop2 { get; set; }
        /// <summary>
        /// Loop for Quantity and Description
        /// </summary>
        [DataMember]
    ...
    public class TS355 : EdiMessage
    {
        ...
        [DataMember]
        [Pos(4)]
        public virtual Loop_VEH_355 VEHLoop { get; set; }
        /// <summary>
        /// Loop for Individual or Organizational Name
        /// </summary>
        [DataMember]
        [ListCount(999)]
        [Pos(5)]
        public virtual List<Loop_NM1_355> NM1Loop { get; set; }
        /// <summary>
        /// Loop for Port Information
        /// </summary>
        [DataMember]
