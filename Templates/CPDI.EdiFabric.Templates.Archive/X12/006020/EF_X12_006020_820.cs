namespace EdiFabric.Templates.X12006020
{
    ...
    public class Loop_HD_820
    {
        ...
        [DataMember]
        [Pos(4)]
        public virtual List<Loop_RMR_820_2> RMRLoop { get; set; }
    }
    ...
    public class Loop_INS_820
    {
        ...
        [DataMember]
        [Pos(7)]
        public virtual List<Loop_ADX_820_3> ADXLoop { get; set; }
        /// <summary>
        /// Loop for Health Coverage
        /// </summary>
        [DataMember]
        [Pos(8)]
        public virtual List<Loop_HD_820> HDLoop { get; set; }
        /// <summary>
        /// Loop for Party Identification
        /// </summary>
        [DataMember]
        [Pos(9)]
        public virtual List<Loop_N1_820_3> N1Loop { get; set; }
    }
    ...
    public class Loop_RMR_820_2
    {
        ...
        [DataMember]
        [Pos(4)]
        public virtual List<Loop_ADX_820_4> ADXLoop { get; set; }
    }
    ...
    public class TS820 : EdiMessage
    {
        ...
        [DataMember]
        [Pos(15)]
        public virtual List<Loop_INS_820> INSLoop { get; set; }
        /// <summary>
