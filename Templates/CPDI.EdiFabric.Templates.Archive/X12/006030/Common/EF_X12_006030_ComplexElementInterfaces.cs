namespace EdiFabric.Templates.X12006030
{
    ...
    public interface I_C034
    {
        ...
        string AssuranceAlgorithmCode_01 { get; set; }
        string HashingAlgorithmCode_02 { get; set; }
    }
    ...
    public interface I_C058
    {
        ...
        string ClaimAdjustmentReasonCode_01 { get; set; }
        string CodeListQualifierCode_02 { get; set; }
        string IndustryCode_03 { get; set; }
    ...
    public interface I_C059
    {
        ...
        string ReasonforServiceCode_01 { get; set; }
        string ProfessionalServiceCode_02 { get; set; }
        string ResultofServiceCode_03 { get; set; }
    }
    
    public interface I_C060
    {
