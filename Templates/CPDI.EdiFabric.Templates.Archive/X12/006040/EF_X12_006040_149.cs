namespace EdiFabric.Templates.X12006040
{
    ...
    public class Loop_FGS_149
    {
        ...
        [ListCount(99999)]
        [Pos(7)]
        public virtual List<Loop_AMT_149> LoopAMT { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(8)]
        public virtual List<Loop_N1_149_2> LoopN1 { get; set; }
    }
    ...
    public class Loop_TFS_149
    {
        ...
        [ListCount(99999)]
        [Pos(6)]
        public virtual List<Loop_FGS_149> LoopFGS { get; set; }
    }
    ...
    public class TS149 : EdiMessage
    {
        ...
        [ListCount(99999)]
        [Pos(7)]
        public virtual List<Loop_N1_149> LoopN1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(8)]
        public virtual List<Loop_TFS_149> LoopTFS { get; set; }
        /// <summary>
