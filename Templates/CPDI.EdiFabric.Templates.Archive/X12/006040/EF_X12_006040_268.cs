namespace EdiFabric.Templates.X12006040
{
    ...
    public class Loop_CON_268
    {
        ...
        [ListCount(99999)]
        [Pos(8)]
        public virtual List<Loop_NM1_268_2> LoopNM1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(9)]
        public virtual List<Loop_BLI_268> LoopBLI { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(10)]
        public virtual List<Loop_IT1_268> LoopIT1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(11)]
        public virtual List<Loop_LX_268> LoopLX { get; set; }
    }
    ...
    public class Loop_IT1_268
    {
        ...
        [ListCount(99999)]
        [Pos(7)]
        public virtual List<Loop_ACT_268_2> LoopACT { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(8)]
        public virtual List<Loop_NM1_268_3> LoopNM1 { get; set; }
    }
    ...
    public class Loop_LX_268
    {
        ...
        [ListCount(99999)]
        [Pos(4)]
        public virtual List<Loop_RPA_268> LoopRPA { get; set; }
    }
    ...
    public class Loop_N1_268
    {
        ...
        [ListCount(99999)]
        [Pos(7)]
        public virtual List<Loop_PID_268> LoopPID { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(8)]
        public virtual List<Loop_PO1_268> LoopPO1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(9)]
        public virtual List<Loop_ACT_268> LoopACT { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(10)]
        public virtual List<Loop_CON_268> LoopCON { get; set; }
    }
    ...
    public class Loop_NM1_268_3
    {
        ...
        [ListCount(99999)]
        [Pos(10)]
        public virtual List<Loop_EFI_268> LoopEFI { get; set; }
    }
    ...
    public class Loop_RPA_268
    {
        ...
        [ListCount(99999)]
        [Pos(3)]
        public virtual List<Loop_AMT_268> LoopAMT { get; set; }
    }
    ...
    public class TS268 : EdiMessage
    {
        ...
        [ListCount(2)]
        [Pos(5)]
        public virtual List<Loop_NM1_268> LoopNM1 { get; set; }
        [DataMember]
        [Required]
        [ListCount(99999)]
        [Pos(6)]
        public virtual List<Loop_N1_268> LoopN1 { get; set; }
        /// <summary>
