namespace EdiFabric.Templates.X12006040
{
    ...
    public class Loop_HL_284
    {
        ...
        [ListCount(99999)]
        [Pos(12)]
        public virtual List<Loop_LQ_284> LoopLQ { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(13)]
        public virtual List<Loop_NM1_284_2> LoopNM1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(14)]
    ...
    public class TS284 : EdiMessage
    {
        ...
        [ListCount(99999)]
        [Pos(3)]
        public virtual List<Loop_NM1_284> LoopNM1 { get; set; }
        [DataMember]
        [Required]
        [ListCount(99999)]
        [Pos(4)]
        public virtual List<Loop_HL_284> LoopHL { get; set; }
        /// <summary>
