namespace EdiFabric.Templates.X12006040
{
    ...
    public class Loop_HL_650
    {
        ...
        [ListCount(99999)]
        [Pos(11)]
        public virtual List<Loop_CLI_650> LoopCLI { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(12)]
        public virtual List<Loop_LM_650> LoopLM { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(13)]
        public virtual List<Loop_NM1_650> LoopNM1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(14)]
        public virtual List<Loop_MTX_650> LoopMTX { get; set; }
    }
    ...
    public class TS650 : EdiMessage
    {
        ...
        [ListCount(99999)]
        [Pos(5)]
        public virtual List<Loop_N1_650> LoopN1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(6)]
        public virtual List<Loop_LM_650> LoopLM { get; set; }
        ...
        [ListCount(99999)]
        [Pos(7)]
        public virtual List<Loop_HL_650> LoopHL { get; set; }
        /// <summary>
