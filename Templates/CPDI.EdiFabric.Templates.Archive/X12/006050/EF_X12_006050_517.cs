namespace EdiFabric.Templates.X12006050
{
    ...
    public class Loop_QTY_517
    {
        ...
        [ListCount(10)]
        [Pos(6)]
        public virtual List<Loop_LM_517> LoopLM { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(7)]
        public virtual List<Loop_N1_517> LoopN1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(8)]
        public virtual List<Loop_FA1_517> LoopFA1 { get; set; }
    }
    ...
    public class TS517 : EdiMessage
    {
        ...
        [ListCount(99999)]
        [Pos(6)]
        public virtual List<Loop_QTY_517> LoopQTY { get; set; }
        /// <summary>
