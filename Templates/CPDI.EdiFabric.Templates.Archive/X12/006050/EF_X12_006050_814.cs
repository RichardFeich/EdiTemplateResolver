namespace EdiFabric.Templates.X12006050
{
    ...
    public class Loop_FA1_814
    {
        ...
        [ListCount(99999)]
        [Pos(3)]
        public virtual List<Loop_AMT_814> LoopAMT { get; set; }
    }
    ...
    public class Loop_LIN_814
    {
        ...
        [ListCount(99999)]
        [Pos(10)]
        public virtual List<Loop_FA1_814> LoopFA1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(11)]
        public virtual List<Loop_NM1_814> LoopNM1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(12)]
        public virtual List<Loop_LM_814> LoopLM { get; set; }
    }
    ...
    public class TS814 : EdiMessage
    {
        ...
        [ListCount(99999)]
        [Pos(10)]
        public virtual List<Loop_N1_814> LoopN1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(11)]
        public virtual List<Loop_LM_814> LoopLM { get; set; }
        ...
        [ListCount(99999)]
        [Pos(12)]
        public virtual List<Loop_LIN_814> LoopLIN { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(13)]
        public virtual List<Loop_AWD_814> LoopAWD { get; set; }
        /// <summary>
