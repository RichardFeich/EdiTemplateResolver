namespace EdiFabric.Templates.X12007010
{
    ...
    public class TS108 : EdiMessage
    {
        ...
        [ListCount(10)]
        [Pos(5)]
        public virtual List<Loop_0100_108> Loop0100 { get; set; }
        [DataMember]
        [Required]
        [ListCount(99999)]
        [Pos(6)]
        public virtual List<Loop_0200_108> Loop0200 { get; set; }
        /// <summary>
