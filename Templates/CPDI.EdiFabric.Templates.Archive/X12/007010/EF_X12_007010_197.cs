namespace EdiFabric.Templates.X12007010
{
    ...
    public class Loop_FGS_197
    {
        ...
        [ListCount(99999)]
        [Pos(6)]
        public virtual List<Loop_IN1_197> LoopIN1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(7)]
        public virtual List<Loop_LQ_197> LoopLQ { get; set; }
    }
    ...
    public class Loop_LQ_197
    {
        ...
        [ListCount(99999)]
        [Pos(5)]
        public virtual List<Loop_IN1_197_2> LoopIN1 { get; set; }
    }
    ...
    public class Loop_NM1_197
    {
        ...
        [ListCount(99999)]
        [Pos(5)]
        public virtual List<Loop_EFI_197> LoopEFI { get; set; }
    }
    ...
    public class Loop_PID_197
    {
        ...
        [ListCount(5)]
        [Pos(5)]
        public virtual List<Loop_NM1_197> LoopNM1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(6)]
        public virtual List<Loop_NX1_197> LoopNX1 { get; set; }
        [DataMember]
        [Required]
        [ListCount(10)]
        [Pos(7)]
        public virtual List<Loop_FGS_197> LoopFGS { get; set; }
        [DataMember]
        [Pos(8)]
        public virtual Loop_LX_197 LoopLX { get; set; }
    }
    ...
    public class TS197 : EdiMessage
    {
        ...
        [ListCount(5)]
        [Pos(3)]
        public virtual List<Loop_N1_197> LoopN1 { get; set; }
        [DataMember]
        [Required]
        [ListCount(99999)]
        [Pos(4)]
        public virtual List<Loop_PID_197> LoopPID { get; set; }
        /// <summary>
