namespace EdiFabric.Templates.X12007010
{
    ...
    public class Loop_ACT_252
    {
        ...
        [ListCount(99999)]
        [Pos(2)]
        public virtual List<Loop_SPA_252> LoopSPA { get; set; }
    }
    ...
    public class Loop_ENT_252
    {
        ...
        [ListCount(99999)]
        [Pos(11)]
        public virtual List<Loop_NM1_252_2> LoopNM1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(12)]
        public virtual List<Loop_LX_252> LoopLX { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(13)]
        public virtual List<Loop_UC_252> LoopUC { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(14)]
        public virtual List<Loop_LIC_252> LoopLIC { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(15)]
        public virtual List<Loop_ACT_252> LoopACT { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(16)]
        public virtual List<Loop_PWK_252> LoopPWK { get; set; }
    }
    ...
    public class Loop_LIC_252
    {
        ...
        [ListCount(99999)]
        [Pos(4)]
        public virtual List<Loop_LIN_252> LoopLIN { get; set; }
    }
    ...
    public class Loop_LX_252
    {
        ...
        [ListCount(99999)]
        [Pos(5)]
        public virtual List<Loop_REF_252> LoopREF { get; set; }
    }
    ...
    public class Loop_N1_252
    {
        ...
        [ListCount(99999)]
        [Pos(7)]
        public virtual List<Loop_ENT_252> LoopENT { get; set; }
    }
    ...
    public class Loop_NM1_252_2
    {
        ...
        [ListCount(99999)]
        [Pos(5)]
        public virtual List<Loop_N9_252> LoopN9 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(6)]
        public virtual List<Loop_N3_252> LoopN3 { get; set; }
    }
    ...
    public class Loop_PWK_252
    {
        ...
        [ListCount(99999)]
        [Pos(5)]
        public virtual List<Loop_EFI_252> LoopEFI { get; set; }
    }
    ...
    public class TS252 : EdiMessage
    {
        ...
        [ListCount(99999)]
        [Pos(4)]
        public virtual List<Loop_NM1_252> LoopNM1 { get; set; }
        [DataMember]
        [Required]
        [ListCount(99999)]
        [Pos(5)]
        public virtual List<Loop_N1_252> LoopN1 { get; set; }
        /// <summary>
