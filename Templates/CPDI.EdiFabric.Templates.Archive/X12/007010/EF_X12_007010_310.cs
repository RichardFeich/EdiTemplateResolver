namespace EdiFabric.Templates.X12007010
{
    ...
    public class Loop_L0_310
    {
        ...
        [ListCount(20)]
        [Pos(3)]
        public virtual List<Loop_L1_310> LoopL1 { get; set; }
        /// <summary>
        // Tariff Reference
        /// </summary>
        [DataMember]
        ...
        [ListCount(20)]
        [Pos(7)]
        public virtual List<Loop_C8_310> LoopC8 { get; set; }
        [DataMember]
        [ListCount(10)]
        [Pos(8)]
        public virtual List<Loop_H1_310> LoopH1 { get; set; }
        [DataMember]
        [ListCount(100)]
        [Pos(9)]
        public virtual List<Loop_LH1_310> LoopLH1 { get; set; }
    }
    ...
    public class Loop_LX_310
    {
        ...
        [ListCount(999)]
        [Pos(2)]
        public virtual List<Loop_N7_310> LoopN7 { get; set; }
        [DataMember]
        [ListCount(120)]
        [Pos(3)]
        public virtual List<Loop_L0_310> LoopL0 { get; set; }
    }
    ...
    public class TS310 : EdiMessage
    {
        ...
        [ListCount(10)]
        [Pos(13)]
        public virtual List<Loop_N1_310> LoopN1 { get; set; }
        /// <summary>
        // Contact
        /// </summary>
        [DataMember]
        ...
        [ListCount(20)]
        [Pos(15)]
        public virtual List<Loop_R4_310> LoopR4 { get; set; }
        /// <summary>
        ...
        [ListCount(999)]
        [Pos(22)]
        public virtual List<Loop_LX_310> LoopLX { get; set; }
        /// <summary>
