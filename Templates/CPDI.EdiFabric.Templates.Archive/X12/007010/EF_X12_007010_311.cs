namespace EdiFabric.Templates.X12007010
{
    ...
    public class Loop_LX_311
    {
        ...
        [ListCount(999)]
        [Pos(3)]
        public virtual List<Loop_ED_311> LoopED { get; set; }
        [DataMember]
        [ListCount(120)]
        [Pos(4)]
        public virtual List<Loop_L0_311> LoopL0 { get; set; }
    }
    ...
    public class TS311 : EdiMessage
    {
        ...
        [ListCount(10)]
        [Pos(9)]
        public virtual List<Loop_N1_311> LoopN1 { get; set; }
        /// <summary>
        // Port or Terminal
        /// </summary>
        [DataMember]
        ...
        [ListCount(999)]
        [Pos(12)]
        public virtual List<Loop_LX_311> LoopLX { get; set; }
        /// <summary>
