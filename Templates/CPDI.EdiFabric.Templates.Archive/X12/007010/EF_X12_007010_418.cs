namespace EdiFabric.Templates.X12007010
{
    ...
    public class Loop_LH1_418
    {
        ...
        [ListCount(10)]
        [Pos(10)]
        public virtual List<Loop_N1_418> LoopN1 { get; set; }
    }
    ...
    public class Loop_LS_418
    {
        ...
        [ListCount(1000)]
        [Pos(2)]
        public virtual List<Loop_LH1_418> LoopLH1 { get; set; }
        /// <summary>
        // Loop Trailer
        /// </summary>
        [DataMember]
    ...
    public class Loop_W1_418
    {
        ...
        [ListCount(800)]
        [Pos(2)]
        public virtual List<Loop_W2_418> LoopW2 { get; set; }
    }
    ...
    public class Loop_W2_418
    {
        ...
        [DataMember]
        [Pos(9)]
        public virtual Loop_LS_418 LoopLS { get; set; }
        /// <summary>
        // Administrative Communications Contact
        /// </summary>
        [DataMember]
    ...
    public class TS418 : EdiMessage
    {
        ...
        [ListCount(999)]
        [Pos(3)]
        public virtual List<Loop_NM1_418> LoopNM1 { get; set; }
        [DataMember]
        [ListCount(30)]
        [Pos(4)]
        public virtual List<Loop_W1_418> LoopW1 { get; set; }
        /// <summary>
