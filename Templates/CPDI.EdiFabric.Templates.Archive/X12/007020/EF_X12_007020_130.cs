namespace EdiFabric.Templates.X12007020
{
    ...
    public class Loop_CRS_130
    {
        ...
        [ListCount(10)]
        [Pos(9)]
        public virtual List<Loop_MKS_130> LoopMKS { get; set; }
    }
    ...
    public class Loop_IN1_130
    {
        ...
        [ListCount(5)]
        [Pos(4)]
        public virtual List<Loop_N3_130> LoopN3 { get; set; }
        /// <summary>
        // Administrative Communications Contact
        /// </summary>
        [DataMember]
    ...
    public class Loop_LX_130
    {
        ...
        [ListCount(1000)]
        [Pos(4)]
        public virtual List<Loop_HC_130> LoopHC { get; set; }
        [DataMember]
        [ListCount(30)]
        [Pos(5)]
        public virtual List<Loop_SP_130> LoopSP { get; set; }
        [DataMember]
        [ListCount(1000)]
        [Pos(6)]
        public virtual List<Loop_SES_130> LoopSES { get; set; }
    }
    ...
    public class Loop_SES_130
    {
        ...
        [ListCount(5)]
        [Pos(7)]
        public virtual List<Loop_SUM_130> LoopSUM { get; set; }
        [DataMember]
        [ListCount(50)]
        [Pos(8)]
        public virtual List<Loop_CRS_130> LoopCRS { get; set; }
        [DataMember]
        [ListCount(10)]
        [Pos(9)]
        public virtual List<Loop_DEG_130> LoopDEG { get; set; }
    }
    ...
    public class Loop_SP_130
    {
        ...
        [ListCount(10)]
        [Pos(6)]
        public virtual List<Loop_OPS_130> LoopOPS { get; set; }
    }
    ...
    public class Loop_TST_130
    {
        ...
        [ListCount(99999)]
        [Pos(2)]
        public virtual List<Loop_SBT_130> LoopSBT { get; set; }
    }
    ...
    public class TS130 : EdiMessage
    {
        ...
        [ListCount(2)]
        [Pos(12)]
        public virtual List<Loop_N1_130> LoopN1 { get; set; }
        [DataMember]
        [Required]
        [ListCount(15)]
        [Pos(13)]
        public virtual List<Loop_IN1_130> LoopIN1 { get; set; }
        [DataMember]
        [ListCount(500)]
        [Pos(14)]
        public virtual List<Loop_SST_130> LoopSST { get; set; }
        [DataMember]
        [ListCount(100)]
        [Pos(15)]
        public virtual List<Loop_ATV_130> LoopATV { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(16)]
        public virtual List<Loop_TST_130> LoopTST { get; set; }
        [DataMember]
        [ListCount(5)]
        [Pos(17)]
        public virtual List<Loop_SUM_130> LoopSUM { get; set; }
        [DataMember]
        [Pos(18)]
        public virtual Loop_LX_130 LoopLX { get; set; }
    }
}
