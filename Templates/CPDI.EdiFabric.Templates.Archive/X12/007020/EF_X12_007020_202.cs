namespace EdiFabric.Templates.X12007020
{
    ...
    public class Loop_CRC_202
    {
        ...
        [ListCount(99999)]
        [Pos(10)]
        public virtual List<Loop_SCM_202> LoopSCM { get; set; }
    }
    ...
    public class Loop_DEX_202
    {
        ...
        [ListCount(99999)]
        [Pos(11)]
        public virtual List<Loop_ASM_202> LoopASM { get; set; }
        [DataMember]
        [Required]
        [ListCount(99999)]
        [Pos(12)]
        public virtual List<Loop_NM1_202> LoopNM1 { get; set; }
    }
    ...
    public class Loop_LX_202
    {
        ...
        [ListCount(99999)]
        [Pos(17)]
        public virtual List<Loop_IGI_202> LoopIGI { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(18)]
        public virtual List<Loop_NX1_202> LoopNX1 { get; set; }
        [DataMember]
        [ListCount(5)]
        [Pos(19)]
        public virtual List<Loop_LN1_202> LoopLN1 { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(20)]
        public virtual List<Loop_CRC_202> LoopCRC { get; set; }
        [DataMember]
        [ListCount(4)]
        [Pos(21)]
        public virtual List<Loop_PAM_202> LoopPAM { get; set; }
        [DataMember]
        [ListCount(5)]
        [Pos(22)]
        public virtual List<Loop_UWI_202> LoopUWI { get; set; }
    }
    ...
    public class Loop_N9_202
    {
        ...
        [ListCount(99999)]
        [Pos(2)]
        public virtual List<Loop_DEX_202> LoopDEX { get; set; }
    }
    ...
    public class Loop_NM1_202
    {
        ...
        [ListCount(99999)]
        [Pos(2)]
        public virtual List<Loop_LX_202> LoopLX { get; set; }
    }
    ...
    public class TS202 : EdiMessage
    {
        ...
        [ListCount(5)]
        [Pos(5)]
        public virtual List<Loop_N1_202> LoopN1 { get; set; }
        [DataMember]
        [Required]
        [ListCount(99999)]
        [Pos(6)]
        public virtual List<Loop_N9_202> LoopN9 { get; set; }
        /// <summary>
        // Transaction Totals
        /// </summary>
        [DataMember]
