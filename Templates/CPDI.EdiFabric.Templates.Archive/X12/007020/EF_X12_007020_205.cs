namespace EdiFabric.Templates.X12007020
{
    ...
    public class Loop_CDI_205
    {
        ...
        [ListCount(99999)]
        [Pos(2)]
        public virtual List<Loop_LX_205> LoopLX { get; set; }
    }
    ...
    public class Loop_IN1_205
    {
        ...
        [ListCount(99999)]
        [Pos(5)]
        public virtual List<Loop_NX1_205> LoopNX1 { get; set; }
    }
    ...
    public class Loop_MNC_205
    {
        ...
        [ListCount(99999)]
        [Pos(12)]
        public virtual List<Loop_CDI_205> LoopCDI { get; set; }
        [DataMember]
        [Required]
        [ListCount(99999)]
        [Pos(13)]
        public virtual List<Loop_IN1_205> LoopIN1 { get; set; }
    }
    ...
    public class TS205 : EdiMessage
    {
        ...
        [ListCount(5)]
        [Pos(4)]
        public virtual List<Loop_NM1_205> LoopNM1 { get; set; }
        [DataMember]
        [Required]
        [ListCount(99999)]
        [Pos(5)]
        public virtual List<Loop_MNC_205> LoopMNC { get; set; }
        /// <summary>
        // Transaction Totals
        /// </summary>
        [DataMember]
