namespace EdiFabric.Templates.X12007020
{
    ...
    public class Loop_ANI_249
    {
        ...
        [ListCount(99999)]
        [Pos(7)]
        public virtual List<Loop_AST_249> LoopAST { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(8)]
    ...
    public class Loop_GID_249
    {
        ...
        [ListCount(99999)]
        [Pos(6)]
        public virtual List<Loop_N1_249_2> LoopN1 { get; set; }
        [DataMember]
        [Required]
        [ListCount(99999)]
        [Pos(7)]
    ...
    public class TS249 : EdiMessage
    {
        ...
        [ListCount(99999)]
        [Pos(4)]
        public virtual List<Loop_N1_249> LoopN1 { get; set; }
        [DataMember]
        [Required]
        [ListCount(99999)]
        [Pos(5)]
        public virtual List<Loop_GID_249> LoopGID { get; set; }
        /// <summary>
