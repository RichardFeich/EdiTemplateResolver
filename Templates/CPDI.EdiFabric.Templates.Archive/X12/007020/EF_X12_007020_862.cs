namespace EdiFabric.Templates.X12007020
{
    ...
    public class Loop_FST_862
    {
        ...
        [ListCount(96)]
        [Pos(4)]
        public virtual List<Loop_JIT_862> LoopJIT { get; set; }
    }
    ...
    public class Loop_LIN_862
    {
        ...
        [ListCount(100)]
        [Pos(10)]
        public virtual List<Loop_FST_862> LoopFST { get; set; }
        [DataMember]
        [ListCount(10)]
        [Pos(11)]
        public virtual List<Loop_SHP_862> LoopSHP { get; set; }
        /// <summary>
    ...
    public class TS862 : EdiMessage
    {
        ...
        [ListCount(200)]
        [Pos(4)]
        public virtual List<Loop_N1_862> LoopN1 { get; set; }
        [DataMember]
        [Required]
        [ListCount(99999)]
        [Pos(5)]
        public virtual List<Loop_LIN_862> LoopLIN { get; set; }
        /// <summary>
        // Transaction Totals
        /// </summary>
        [DataMember]
