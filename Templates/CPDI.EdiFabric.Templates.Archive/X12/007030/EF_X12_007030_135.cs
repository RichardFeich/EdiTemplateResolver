namespace EdiFabric.Templates.X12007030
{
    ...
    public class Loop_ENT_135
    {
        ...
        [ListCount(2)]
        [Pos(11)]
        public virtual List<Loop_N1_135> LoopN1 { get; set; }
        [DataMember]
        [ListCount(10)]
        [Pos(12)]
        public virtual List<Loop_PLI_135> LoopPLI { get; set; }
        [DataMember]
        [ListCount(10)]
        [Pos(13)]
        public virtual List<Loop_IN1_135> LoopIN1 { get; set; }
        [DataMember]
        [Pos(14)]
        public virtual Loop_LM_135 LoopLM { get; set; }
    }
    ...
    public class Loop_IN1_135
    {
        ...
        [ListCount(4)]
        [Pos(5)]
        public virtual List<Loop_LX_135_2> LoopLX { get; set; }
    }
    ...
    public class TS135 : EdiMessage
    {
        ...
        [ListCount(99999)]
        [Pos(6)]
        public virtual List<Loop_LX_135> LoopLX { get; set; }
        [DataMember]
        [Required]
        [ListCount(6)]
        [Pos(7)]
        public virtual List<Loop_ENT_135> LoopENT { get; set; }
        /// <summary>
