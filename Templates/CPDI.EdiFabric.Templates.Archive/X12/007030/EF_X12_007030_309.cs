namespace EdiFabric.Templates.X12007030
{
    ...
    public class Loop_LX_309
    {
        ...
        [ListCount(25)]
        [Pos(5)]
        public virtual List<Loop_N1_309> LoopN1 { get; set; }
        [DataMember]
        [Pos(6)]
        public virtual Loop_M12_309 LoopM12 { get; set; }
        [DataMember]
        [ListCount(999)]
        [Pos(7)]
        public virtual List<Loop_VID_309> LoopVID { get; set; }
    }
    ...
    public class Loop_N1_309_2
    {
        ...
        [ListCount(999)]
        [Pos(4)]
        public virtual List<Loop_N10_309> LoopN10 { get; set; }
    }
    ...
    public class Loop_N10_309
    {
        ...
        [ListCount(99)]
        [Pos(4)]
        public virtual List<Loop_H1_309> LoopH1 { get; set; }
    }
    
    [Serializable()]
    [DataContract()]
    [Group(typeof(NM1))]
    public class Loop_NM1_309
    {
    ...
    public class Loop_P4_309
    {
        ...
        [ListCount(9999)]
        [Pos(2)]
        public virtual List<Loop_LX_309> LoopLX { get; set; }
    }
    ...
    public class Loop_VID_309
    {
        ...
        [ListCount(999)]
        [Pos(3)]
        public virtual List<Loop_N1_309_2> LoopN1 { get; set; }
    }
    ...
    public class TS309 : EdiMessage
    {
        ...
        [ListCount(999)]
        [Pos(7)]
        public virtual List<Loop_NM1_309> LoopNM1 { get; set; }
        [DataMember]
        [Required]
        [ListCount(20)]
        [Pos(8)]
        public virtual List<Loop_P4_309> LoopP4 { get; set; }
        /// <summary>
