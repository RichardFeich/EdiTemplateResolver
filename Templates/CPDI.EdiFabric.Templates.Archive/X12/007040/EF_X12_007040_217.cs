namespace EdiFabric.Templates.X12007040
{
    ...
    public class Loop_LS_217
    {
        ...
        [ListCount(999999)]
        [Pos(2)]
        public virtual List<Loop_0200_217> Loop0200 { get; set; }
        /// <summary>
        // Loop Trailer
        /// </summary>
        [DataMember]
    ...
    public class TS217 : EdiMessage
    {
        ...
        [ListCount(999999)]
        [Pos(3)]
        public virtual List<Loop_0100_217> Loop0100 { get; set; }
        [DataMember]
        [Pos(4)]
        public virtual Loop_LS_217 LoopLS { get; set; }
        [DataMember]
        [ListCount(999999)]
        [Pos(5)]
        public virtual List<Loop_0300_217> Loop0300 { get; set; }
        /// <summary>
