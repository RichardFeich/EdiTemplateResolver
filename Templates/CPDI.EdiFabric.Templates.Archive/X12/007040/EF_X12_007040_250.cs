namespace EdiFabric.Templates.X12007040
{
    ...
    public class Loop_0100_250
    {
        ...
        [ListCount(99999)]
        [Pos(7)]
        public virtual List<Loop_0110_250> Loop0110 { get; set; }
    }
    
    [Serializable()]
    [DataContract()]
    [Group(typeof(N1))]
    public class Loop_0110_250
    {
    ...
    public class TS250 : EdiMessage
    {
        ...
        [ListCount(99999)]
        [Pos(5)]
        public virtual List<Loop_0100_250> Loop0100 { get; set; }
        /// <summary>
