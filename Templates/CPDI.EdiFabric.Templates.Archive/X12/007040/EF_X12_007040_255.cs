namespace EdiFabric.Templates.X12007040
{
    ...
    public class Loop_ACT_255
    {
        ...
        [ListCount(99999)]
        [Pos(10)]
        public virtual List<Loop_NM1_255_2> LoopNM1 { get; set; }
    }
    ...
    public class Loop_LS_255
    {
        ...
        [ListCount(99999)]
        [Pos(2)]
        public virtual List<Loop_LX_255_2> LoopLX { get; set; }
        /// <summary>
        // Loop Trailer
        /// </summary>
        [DataMember]
    ...
    public class Loop_NM1_255_2
    {
        ...
        [ListCount(99999)]
        [Pos(3)]
        public virtual List<Loop_LX_255> LoopLX { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(4)]
        public virtual List<Loop_EFI_255> LoopEFI { get; set; }
        [DataMember]
        [ListCount(99999)]
        [Pos(5)]
        public virtual List<Loop_PO1_255> LoopPO1 { get; set; }
    }
    ...
    public class Loop_PO1_255
    {
        ...
        [DataMember]
        [Pos(7)]
        public virtual Loop_LS_255 LoopLS { get; set; }
    }
    ...
    public class TS255 : EdiMessage
    {
        ...
        [ListCount(9)]
        [Pos(4)]
        public virtual List<Loop_NM1_255> LoopNM1 { get; set; }
        [DataMember]
        [Required]
        [ListCount(99999)]
        [Pos(5)]
        public virtual List<Loop_ACT_255> LoopACT { get; set; }
        /// <summary>
