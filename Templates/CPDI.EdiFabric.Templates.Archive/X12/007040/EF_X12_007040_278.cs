namespace EdiFabric.Templates.X12007040
{
    ...
    public class Loop_2000_278
    {
        ...
        [ListCount(99999)]
        [Pos(14)]
        public virtual List<DRA> DRA { get; set; }
        /// <summary>
        ...
        [ListCount(99999)]
        [Pos(27)]
        public virtual List<Loop_2010_278> Loop2010 { get; set; }
    }
    
    [Serializable()]
    [DataContract()]
    [Group(typeof(NM1))]
    public class Loop_2010_278
    {
    ...
    public class TS278 : EdiMessage
    {
        ...
        [ListCount(99999)]
        [Pos(3)]
        public virtual List<Loop_2000_278> Loop2000 { get; set; }
        /// <summary>
