namespace EdiFabric.Templates.X12007040
{
    ...
    public class Loop_L0_301
    {
        ...
        [ListCount(100)]
        [Pos(5)]
        public virtual List<Loop_H1_301> LoopH1 { get; set; }
        [DataMember]
        [ListCount(100)]
        [Pos(6)]
    ...
    public class TS301 : EdiMessage
    {
        ...
        [ListCount(10)]
        [Pos(6)]
        public virtual List<Loop_Y4_301> LoopY4 { get; set; }
        /// <summary>
        ...
        [ListCount(99)]
        [Pos(9)]
        public virtual List<Loop_N1_301> LoopN1 { get; set; }
        [DataMember]
        [Required]
        [ListCount(20)]
        [Pos(10)]
        public virtual List<Loop_R4_301> LoopR4 { get; set; }
        /// <summary>
        // Equipment and Temperature
        /// </summary>
        [DataMember]
        ...
        [ListCount(999)]
        [Pos(14)]
        public virtual List<Loop_LX_301> LoopLX { get; set; }
        /// <summary>
