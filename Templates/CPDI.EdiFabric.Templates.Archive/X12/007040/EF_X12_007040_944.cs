namespace EdiFabric.Templates.X12007040
{
    ...
    public class Loop_0200_944
    {
        ...
        [ListCount(9999)]
        [Pos(5)]
        public virtual List<Loop_0210_944> Loop0210 { get; set; }
    }
    
    [Serializable()]
    [DataContract()]
    [Group(typeof(W07))]
    public class Loop_0210_944
    {
        ...
        [ListCount(50)]
        [Pos(5)]
        public virtual List<Loop_0211_944> Loop0211 { get; set; }
    }
    
    [Serializable()]
    [DataContract()]
    [Group(typeof(W13))]
    public class Loop_0211_944
    {
    ...
    public class TS944 : EdiMessage
    {
        ...
        [ListCount(10)]
        [Pos(3)]
        public virtual List<Loop_0100_944> Loop0100 { get; set; }
        /// <summary>
        // Extended Reference Information
        /// </summary>
        [DataMember]
        ...
        [ListCount(99999)]
        [Pos(12)]
        public virtual List<Loop_0200_944> Loop0200 { get; set; }
        /// <summary>
